...
*AiMentorApi* | [**ai_mentor_orgs_users_create_mentor_wizard_destroy**](docs/AiMentorApi.md#ai_mentor_orgs_users_create_mentor_wizard_destroy) | **DELETE** /api/ai-mentor/orgs/{org}/users/{user_id}/create-mentor-wizard/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_create_mentor_wizard_partial_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_create_mentor_wizard_partial_update) | **PATCH** /api/ai-mentor/orgs/{org}/users/{user_id}/create-mentor-wizard/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_create_mentor_wizard_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_create_mentor_wizard_update) | **PUT** /api/ai-mentor/orgs/{org}/users/{user_id}/create-mentor-wizard/ | 
...
*AiMentorApi* | [**ai_mentor_orgs_users_mentor_seed_create**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentor_seed_create) | **POST** /api/ai-mentor/orgs/{org}/users/{user_id}/mentor/seed/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentor_seed_destroy**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentor_seed_destroy) | **DELETE** /api/ai-mentor/orgs/{org}/users/{user_id}/mentor/seed/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentor_seed_partial_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentor_seed_partial_update) | **PATCH** /api/ai-mentor/orgs/{org}/users/{user_id}/mentor/seed/ | 
...
*AiMentorApi* | [**ai_mentor_orgs_users_mentor_seed_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentor_seed_update) | **PUT** /api/ai-mentor/orgs/{org}/users/{user_id}/mentor/seed/ | 
...
*AiMentorApi* | [**ai_mentor_orgs_users_mentor_with_settings_destroy**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentor_with_settings_destroy) | **DELETE** /api/ai-mentor/orgs/{org}/users/{user_id}/mentor-with-settings/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentor_with_settings_partial_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentor_with_settings_partial_update) | **PATCH** /api/ai-mentor/orgs/{org}/users/{user_id}/mentor-with-settings/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentor_with_settings_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentor_with_settings_update) | **PUT** /api/ai-mentor/orgs/{org}/users/{user_id}/mentor-with-settings/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentors_audit_logs_list**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentors_audit_logs_list) | **GET** /api/ai-mentor/orgs/{org}/users/{user_id}/mentors/audit-logs/ | List Mentor Audit Logs
...
*AiMentorApi* | [**ai_mentor_orgs_users_mentors_fork_destroy**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentors_fork_destroy) | **DELETE** /api/ai-mentor/orgs/{org}/users/{user_id}/mentors/{mentor}/fork/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentors_fork_partial_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentors_fork_partial_update) | **PATCH** /api/ai-mentor/orgs/{org}/users/{user_id}/mentors/{mentor}/fork/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentors_fork_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentors_fork_update) | **PUT** /api/ai-mentor/orgs/{org}/users/{user_id}/mentors/{mentor}/fork/ | 
...
*AiMentorApi* | [**ai_mentor_orgs_users_mentors_settings_create**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentors_settings_create) | **POST** /api/ai-mentor/orgs/{org}/users/{user_id}/mentors/{mentor}/settings/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentors_settings_destroy**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentors_settings_destroy) | **DELETE** /api/ai-mentor/orgs/{org}/users/{user_id}/mentors/{mentor}/settings/ | 
*AiMentorApi* | [**ai_mentor_orgs_users_mentors_settings_partial_update**](docs/AiMentorApi.md#ai_mentor_orgs_users_mentors_settings_partial_update) | **PATCH** /api/ai-mentor/orgs/{org}/users/{user_id}/mentors/{mentor}/settings/ | 
