...
```sh
pip install git+https://github.com/iblai/ibl-ai-python-sdk.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/iblai/ibl-ai-python-sdk.git`)
