...
------------- | ------------- | -------------
[**ai_analytics_audience_orgs_active_users_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_active_users_over_time_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/active-users/over-time | 
[**ai_analytics_audience_orgs_active_users_per_course_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_active_users_per_course_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/active-users/per-course | 
[**ai_analytics_audience_orgs_active_users_users_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_active_users_users_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/active-users/users | 
[**ai_analytics_audience_orgs_enrollments_courses_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_enrollments_courses_over_time_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/enrollments/courses/{course_id}/over-time | 
[**ai_analytics_audience_orgs_enrollments_courses_users_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_enrollments_courses_users_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/enrollments/courses/{course_id}/users | 
[**ai_analytics_audience_orgs_enrollments_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_enrollments_over_time_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/enrollments/over-time | 
[**ai_analytics_audience_orgs_enrollments_per_course_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_enrollments_per_course_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/enrollments/per-course | 
[**ai_analytics_audience_orgs_registered_users_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_registered_users_over_time_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/registered-users/over-time | 
[**ai_analytics_audience_orgs_registered_users_per_course_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_registered_users_per_course_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/registered-users/per-course | 
[**ai_analytics_audience_orgs_registered_users_retrieve**](AiAnalyticsApi.md#ai_analytics_audience_orgs_registered_users_retrieve) | **GET** /api/ai-analytics/audience/orgs/{org}/registered-users/ | 
[**ai_analytics_costs_pertenant_list**](AiAnalyticsApi.md#ai_analytics_costs_pertenant_list) | **GET** /api/ai-analytics/costs/pertenant/ | 
[**ai_analytics_departments_orgs_retrieve**](AiAnalyticsApi.md#ai_analytics_departments_orgs_retrieve) | **GET** /api/ai-analytics/departments/orgs/{org}/ | 
[**ai_analytics_engagement_orgs_activity_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_activity_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/activity | 
[**ai_analytics_engagement_orgs_course_completion_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_course_completion_over_time_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/course_completion/over-time | 
[**ai_analytics_engagement_orgs_course_completion_per_course_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_course_completion_per_course_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/course_completion/per-course | 
[**ai_analytics_engagement_orgs_courses_time_average_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_time_average_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/time/average | 
[**ai_analytics_engagement_orgs_courses_time_detail_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_time_detail_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/time/detail | 
[**ai_analytics_engagement_orgs_courses_time_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_time_over_time_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/time/over-time | 
[**ai_analytics_engagement_orgs_courses_time_users_detail_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_time_users_detail_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/time/users/{user_id}/detail | 
[**ai_analytics_engagement_orgs_courses_time_users_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_time_users_over_time_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/time/users/{user_id}/over-time | 
[**ai_analytics_engagement_orgs_courses_time_users_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_time_users_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/time/users | 
[**ai_analytics_engagement_orgs_courses_videos_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_videos_over_time_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/videos/over-time | 
[**ai_analytics_engagement_orgs_courses_videos_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_videos_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/videos/ | 
[**ai_analytics_engagement_orgs_courses_videos_summary_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_videos_summary_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/videos/summary | 
[**ai_analytics_engagement_orgs_courses_videos_users_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_courses_videos_users_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/courses/{course_id}/videos/users | 
[**ai_analytics_engagement_orgs_time_average_perlearner_percourse_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_time_average_perlearner_percourse_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/time/average-perlearner-percourse | 
[**ai_analytics_engagement_orgs_time_average_with_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_time_average_with_over_time_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/time/average-with-over-time | 
[**ai_analytics_engagement_orgs_time_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_time_over_time_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/time/over-time | 
[**ai_analytics_engagement_orgs_time_per_course_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_time_per_course_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/time/per-course | 
[**ai_analytics_engagement_orgs_videos_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_videos_over_time_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/videos/over-time | 
[**ai_analytics_engagement_orgs_videos_retrieve**](AiAnalyticsApi.md#ai_analytics_engagement_orgs_videos_retrieve) | **GET** /api/ai-analytics/engagement/orgs/{org}/videos/ | 
[**ai_analytics_orgs_users_average_messages_per_session_list**](AiAnalyticsApi.md#ai_analytics_orgs_users_average_messages_per_session_list) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/average-messages-per-session/ | 
[**ai_analytics_orgs_users_chat_history_create**](AiAnalyticsApi.md#ai_analytics_orgs_users_chat_history_create) | **POST** /api/ai-analytics/orgs/{org}/users/{user_id}/chat-history/ | 
[**ai_analytics_orgs_users_chat_history_destroy**](AiAnalyticsApi.md#ai_analytics_orgs_users_chat_history_destroy) | **DELETE** /api/ai-analytics/orgs/{org}/users/{user_id}/chat-history/{id}/ | 
...
[**ai_analytics_orgs_users_chat_history_partial_update**](AiAnalyticsApi.md#ai_analytics_orgs_users_chat_history_partial_update) | **PATCH** /api/ai-analytics/orgs/{org}/users/{user_id}/chat-history/{id}/ | 
...
[**ai_analytics_orgs_users_chat_history_update**](AiAnalyticsApi.md#ai_analytics_orgs_users_chat_history_update) | **PUT** /api/ai-analytics/orgs/{org}/users/{user_id}/chat-history/{id}/ | 
[**ai_analytics_orgs_users_conversation_list**](AiAnalyticsApi.md#ai_analytics_orgs_users_conversation_list) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/conversation/ | 
[**ai_analytics_orgs_users_conversation_summary_retrieve**](AiAnalyticsApi.md#ai_analytics_orgs_users_conversation_summary_retrieve) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/conversation-summary/ | 
...
[**ai_analytics_orgs_users_sentiment_count_list**](AiAnalyticsApi.md#ai_analytics_orgs_users_sentiment_count_list) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/sentiment-count/ | 
[**ai_analytics_orgs_users_tenant_cost_retrieve**](AiAnalyticsApi.md#ai_analytics_orgs_users_tenant_cost_retrieve) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/tenant-cost/ | 
[**ai_analytics_orgs_users_top_students_by_chat_messages_list**](AiAnalyticsApi.md#ai_analytics_orgs_users_top_students_by_chat_messages_list) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/top-students-by-chat-messages/ | 
[**ai_analytics_orgs_users_topic_overview_retrieve**](AiAnalyticsApi.md#ai_analytics_orgs_users_topic_overview_retrieve) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/topic-overview/ | 
...
[**ai_analytics_orgs_users_user_cost_retrieve**](AiAnalyticsApi.md#ai_analytics_orgs_users_user_cost_retrieve) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/user-cost/ | 
[**ai_analytics_orgs_users_user_feedback_list**](AiAnalyticsApi.md#ai_analytics_orgs_users_user_feedback_list) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/user-feedback/ | 
[**ai_analytics_orgs_users_user_metrics_pie_chart_retrieve**](AiAnalyticsApi.md#ai_analytics_orgs_users_user_metrics_pie_chart_retrieve) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/user-metrics-pie-chart/ | 
[**ai_analytics_orgs_users_user_metrics_retrieve**](AiAnalyticsApi.md#ai_analytics_orgs_users_user_metrics_retrieve) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/user-metrics/ | 
[**ai_analytics_orgs_users_user_sentiment_retrieve**](AiAnalyticsApi.md#ai_analytics_orgs_users_user_sentiment_retrieve) | **GET** /api/ai-analytics/orgs/{org}/users/{user_id}/user-sentiment/ | 
[**ai_analytics_overview_orgs_active_users_retrieve**](AiAnalyticsApi.md#ai_analytics_overview_orgs_active_users_retrieve) | **GET** /api/ai-analytics/overview/orgs/{org}/active-users | 
[**ai_analytics_overview_orgs_average_grade_retrieve**](AiAnalyticsApi.md#ai_analytics_overview_orgs_average_grade_retrieve) | **GET** /api/ai-analytics/overview/orgs/{org}/average-grade | 
[**ai_analytics_overview_orgs_courses_completions_retrieve**](AiAnalyticsApi.md#ai_analytics_overview_orgs_courses_completions_retrieve) | **GET** /api/ai-analytics/overview/orgs/{org}/courses/completions | 
[**ai_analytics_overview_orgs_learners_retrieve**](AiAnalyticsApi.md#ai_analytics_overview_orgs_learners_retrieve) | **GET** /api/ai-analytics/overview/orgs/{org}/learners | 
[**ai_analytics_overview_orgs_most_active_courses_retrieve**](AiAnalyticsApi.md#ai_analytics_overview_orgs_most_active_courses_retrieve) | **GET** /api/ai-analytics/overview/orgs/{org}/most-active-courses | 
[**ai_analytics_overview_orgs_registered_users_retrieve**](AiAnalyticsApi.md#ai_analytics_overview_orgs_registered_users_retrieve) | **GET** /api/ai-analytics/overview/orgs/{org}/registered-users | 
[**ai_analytics_performance_orgs_courses_grading_average_retrieve**](AiAnalyticsApi.md#ai_analytics_performance_orgs_courses_grading_average_retrieve) | **GET** /api/ai-analytics/performance/orgs/{org}/courses/{course_id}/grading/average | 
[**ai_analytics_performance_orgs_courses_grading_average_with_cutoff_retrieve**](AiAnalyticsApi.md#ai_analytics_performance_orgs_courses_grading_average_with_cutoff_retrieve) | **GET** /api/ai-analytics/performance/orgs/{org}/courses/{course_id}/grading/average-with-cutoff | 
[**ai_analytics_performance_orgs_courses_grading_detail_retrieve**](AiAnalyticsApi.md#ai_analytics_performance_orgs_courses_grading_detail_retrieve) | **GET** /api/ai-analytics/performance/orgs/{org}/courses/{course_id}/grading/detail | 
[**ai_analytics_performance_orgs_courses_grading_per_learner_retrieve**](AiAnalyticsApi.md#ai_analytics_performance_orgs_courses_grading_per_learner_retrieve) | **GET** /api/ai-analytics/performance/orgs/{org}/courses/{course_id}/grading/per-learner | 
[**ai_analytics_performance_orgs_courses_grading_summary_retrieve**](AiAnalyticsApi.md#ai_analytics_performance_orgs_courses_grading_summary_retrieve) | **GET** /api/ai-analytics/performance/orgs/{org}/courses/{course_id}/grading/summary | 
[**ai_analytics_performance_orgs_grading_average_retrieve**](AiAnalyticsApi.md#ai_analytics_performance_orgs_grading_average_retrieve) | **GET** /api/ai-analytics/performance/orgs/{org}/grading/average | 
[**ai_analytics_performance_orgs_grading_per_course_retrieve**](AiAnalyticsApi.md#ai_analytics_performance_orgs_grading_per_course_retrieve) | **GET** /api/ai-analytics/performance/orgs/{org}/grading/per-course | 
[**ai_analytics_perlearner_orgs_learners_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_learners_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/learners | 
[**ai_analytics_perlearner_orgs_users_activity_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_activity_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/activity/ | 
[**ai_analytics_perlearner_orgs_users_courses_grading_cutoffs_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_grading_cutoffs_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/grading/cutoffs | 
[**ai_analytics_perlearner_orgs_users_courses_grading_detail_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_grading_detail_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/grading/detail | 
[**ai_analytics_perlearner_orgs_users_courses_grading_summary_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_grading_summary_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/grading/summary | 
[**ai_analytics_perlearner_orgs_users_courses_overview_engagement_index_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_overview_engagement_index_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/overview/engagement-index | 
[**ai_analytics_perlearner_orgs_users_courses_overview_grade_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_overview_grade_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/overview/grade | 
[**ai_analytics_perlearner_orgs_users_courses_overview_performance_index_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_overview_performance_index_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/overview/performance-index | 
[**ai_analytics_perlearner_orgs_users_courses_overview_time_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_overview_time_over_time_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/overview/time/over-time | 
[**ai_analytics_perlearner_orgs_users_courses_videos_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_videos_over_time_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/videos/over-time | 
[**ai_analytics_perlearner_orgs_users_courses_videos_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_courses_videos_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/courses/{course_id}/videos | 
[**ai_analytics_perlearner_orgs_users_grades_per_course_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_grades_per_course_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/grades/per-course | 
[**ai_analytics_perlearner_orgs_users_info_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_info_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/info | 
[**ai_analytics_perlearner_orgs_users_last_access_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_last_access_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/last-access | 
[**ai_analytics_perlearner_orgs_users_overview_engagement_index_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_overview_engagement_index_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/overview/engagement-index | 
[**ai_analytics_perlearner_orgs_users_overview_grades_average_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_overview_grades_average_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/overview/grades/average | 
[**ai_analytics_perlearner_orgs_users_overview_performance_index_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_overview_performance_index_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/overview/performance-index | 
[**ai_analytics_perlearner_orgs_users_overview_time_over_time_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_overview_time_over_time_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users/{user_id}/overview/time/over-time | 
[**ai_analytics_perlearner_orgs_users_retrieve**](AiAnalyticsApi.md#ai_analytics_perlearner_orgs_users_retrieve) | **GET** /api/ai-analytics/perlearner/orgs/{org}/users | 
...
[**analytics_conversations_retrieve**](AiAnalyticsApi.md#analytics_conversations_retrieve) | **GET** /api/analytics/conversations/ | 
[**analytics_financial_details_retrieve**](AiAnalyticsApi.md#analytics_financial_details_retrieve) | **GET** /api/analytics/financial/details/ | 
[**analytics_financial_invoice_retrieve**](AiAnalyticsApi.md#analytics_financial_invoice_retrieve) | **GET** /api/analytics/financial/invoice/ | 
[**analytics_financial_retrieve**](AiAnalyticsApi.md#analytics_financial_retrieve) | **GET** /api/analytics/financial/ | 
[**analytics_learner_details_retrieve**](AiAnalyticsApi.md#analytics_learner_details_retrieve) | **GET** /api/analytics/learner/details | 
[**analytics_learners_list_retrieve**](AiAnalyticsApi.md#analytics_learners_list_retrieve) | **GET** /api/analytics/learners/list/ | 
[**analytics_learners_retrieve**](AiAnalyticsApi.md#analytics_learners_retrieve) | **GET** /api/analytics/learners/ | 
[**analytics_messages_details_retrieve**](AiAnalyticsApi.md#analytics_messages_details_retrieve) | **GET** /api/analytics/messages/details/ | 
[**analytics_messages_retrieve**](AiAnalyticsApi.md#analytics_messages_retrieve) | **GET** /api/analytics/messages/ | 
...
[**analytics_ratings_retrieve**](AiAnalyticsApi.md#analytics_ratings_retrieve) | **GET** /api/analytics/ratings/ | 
[**analytics_sessions_details_retrieve**](AiAnalyticsApi.md#analytics_sessions_details_retrieve) | **GET** /api/analytics/sessions/details/ | 
[**analytics_sessions_retrieve**](AiAnalyticsApi.md#analytics_sessions_retrieve) | **GET** /api/analytics/sessions/ | 
[**analytics_time_retrieve**](AiAnalyticsApi.md#analytics_time_retrieve) | **GET** /api/analytics/time/ | 
...
[**analytics_topics_details_retrieve**](AiAnalyticsApi.md#analytics_topics_details_retrieve) | **GET** /api/analytics/topics/details/ | 
[**analytics_topics_retrieve**](AiAnalyticsApi.md#analytics_topics_retrieve) | **GET** /api/analytics/topics/ | 
[**analytics_users_details_retrieve**](AiAnalyticsApi.md#analytics_users_details_retrieve) | **GET** /api/analytics/users/details/ | 
[**analytics_users_retrieve**](AiAnalyticsApi.md#analytics_users_retrieve) | **GET** /api/analytics/users/ | 
...
[**get_content_analytics**](AiAnalyticsApi.md#get_content_analytics) | **GET** /api/analytics/content/ | Get Content Analytics
[**get_content_details**](AiAnalyticsApi.md#get_content_details) | **GET** /api/analytics/content/details/{content_id}/ | Get Content Details
...
> OvertimeWithChangeInfo ai_analytics_audience_orgs_active_users_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_active_users_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_active_users_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_active_users_over_time_retrieve: %s\n" % e)
```
...
> ActiveUsersPerCourse ai_analytics_audience_orgs_active_users_per_course_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_active_users_per_course_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_active_users_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_active_users_per_course_retrieve: %s\n" % e)
```
...
> ActiveUsersList ai_analytics_audience_orgs_active_users_users_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_active_users_users_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_active_users_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_active_users_users_retrieve: %s\n" % e)
```
...
> OvertimeWithChangeInfo ai_analytics_audience_orgs_enrollments_courses_over_time_retrieve(course_id, org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_enrollments_courses_over_time_retrieve(course_id, org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_courses_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_courses_over_time_retrieve: %s\n" % e)
```
...
> EnrollmentsPerUser ai_analytics_audience_orgs_enrollments_courses_users_retrieve(course_id, org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_enrollments_courses_users_retrieve(course_id, org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_courses_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_courses_users_retrieve: %s\n" % e)
```
...
> OvertimeWithChangeInfo ai_analytics_audience_orgs_enrollments_over_time_retrieve(org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_enrollments_over_time_retrieve(org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_over_time_retrieve: %s\n" % e)
```
...
> Enrollments ai_analytics_audience_orgs_enrollments_per_course_retrieve(org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_enrollments_per_course_retrieve(org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_enrollments_per_course_retrieve: %s\n" % e)
```
...
> OvertimeWithChangeInfo ai_analytics_audience_orgs_registered_users_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_registered_users_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_registered_users_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_registered_users_over_time_retrieve: %s\n" % e)
```
...
> Enrollments ai_analytics_audience_orgs_registered_users_per_course_retrieve(org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_registered_users_per_course_retrieve(org, active=active, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_registered_users_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_registered_users_per_course_retrieve: %s\n" % e)
```
...
> PerlearnerUserList ai_analytics_audience_orgs_registered_users_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page, search=search)
...
try:
    api_response = api_instance.ai_analytics_audience_orgs_registered_users_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page, search=search)
    print("The response of AiAnalyticsApi->ai_analytics_audience_orgs_registered_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_audience_orgs_registered_users_retrieve: %s\n" % e)
```
...
> List[CostPerTenant] ai_analytics_costs_pertenant_list(end_date, start_date)
...
try:
    api_response = api_instance.ai_analytics_costs_pertenant_list(end_date, start_date)
    print("The response of AiAnalyticsApi->ai_analytics_costs_pertenant_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_costs_pertenant_list: %s\n" % e)
```
...
[**List[CostPerTenant]**](CostPerTenant.md)
...
> GroupList ai_analytics_departments_orgs_retrieve(org, department_id=department_id, departments=departments, end_date=end_date, format=format, include_main_platform=include_main_platform, is_enrolled=is_enrolled, length=length, location=location, page=page, pathway=pathway, program=program, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_departments_orgs_retrieve(org, department_id=department_id, departments=departments, end_date=end_date, format=format, include_main_platform=include_main_platform, is_enrolled=is_enrolled, length=length, location=location, page=page, pathway=pathway, program=program, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_departments_orgs_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_departments_orgs_retrieve: %s\n" % e)
```
...
> EngagementPerCourse ai_analytics_engagement_orgs_activity_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_activity_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_activity_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_activity_retrieve: %s\n" % e)
```
...
> OvertimeWithChangeInfo ai_analytics_engagement_orgs_course_completion_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_course_completion_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_course_completion_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_course_completion_over_time_retrieve: %s\n" % e)
```
...
> CourseCompletionPerCourse ai_analytics_engagement_orgs_course_completion_per_course_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_course_completion_per_course_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_course_completion_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_course_completion_per_course_retrieve: %s\n" % e)
```
...
> AverageOvertime ai_analytics_engagement_orgs_courses_time_average_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_time_average_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_average_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_average_retrieve: %s\n" % e)
```
...
> TimeDetail ai_analytics_engagement_orgs_courses_time_detail_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_time_detail_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_detail_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_detail_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_engagement_orgs_courses_time_over_time_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_time_over_time_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_over_time_retrieve: %s\n" % e)
```
...
> PerLearnerTimeSpentInCourseTree ai_analytics_engagement_orgs_courses_time_users_detail_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_time_users_detail_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_users_detail_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_users_detail_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_engagement_orgs_courses_time_users_over_time_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_time_users_over_time_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_users_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_users_over_time_retrieve: %s\n" % e)
```
...
> TimeSpentByUsersInCourse ai_analytics_engagement_orgs_courses_time_users_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_time_users_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_time_users_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_engagement_orgs_courses_videos_over_time_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_videos_over_time_retrieve(course_id, org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_over_time_retrieve: %s\n" % e)
```
...
> VideosSpecificCourse ai_analytics_engagement_orgs_courses_videos_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_videos_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_retrieve: %s\n" % e)
```
...
> VideosInCourseSummary ai_analytics_engagement_orgs_courses_videos_summary_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_videos_summary_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_summary_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_summary_retrieve: %s\n" % e)
```
...
> WatchedVideosPerUser ai_analytics_engagement_orgs_courses_videos_users_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_courses_videos_users_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_courses_videos_users_retrieve: %s\n" % e)
```
...
> AverageOvertime ai_analytics_engagement_orgs_time_average_perlearner_percourse_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_time_average_perlearner_percourse_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_time_average_perlearner_percourse_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_time_average_perlearner_percourse_retrieve: %s\n" % e)
```
...
> AverageOvertime ai_analytics_engagement_orgs_time_average_with_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_time_average_with_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_time_average_with_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_time_average_with_over_time_retrieve: %s\n" % e)
```
...
> OvertimeWithChangeInfo ai_analytics_engagement_orgs_time_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_time_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_time_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_time_over_time_retrieve: %s\n" % e)
```
...
> TimeSpentPerCourse ai_analytics_engagement_orgs_time_per_course_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_time_per_course_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_time_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_time_per_course_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_engagement_orgs_videos_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_videos_over_time_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_videos_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_videos_over_time_retrieve: %s\n" % e)
```
...
> VideoEngagementPerCourse ai_analytics_engagement_orgs_videos_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
...
try:
    api_response = api_instance.ai_analytics_engagement_orgs_videos_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
    print("The response of AiAnalyticsApi->ai_analytics_engagement_orgs_videos_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_engagement_orgs_videos_retrieve: %s\n" % e)
```
...
> List[MessageStatistics] ai_analytics_orgs_users_average_messages_per_session_list(end_date, org, start_date, user_id, aggregation=aggregation, group_by=group_by, mentor_id=mentor_id)
...
# Create an instance of the API class
api_instance = iblai.AiAnalyticsApi(api_client)
end_date = 'end_date_example' # str | End date for filtering (YYYY-MM-DD)
org = 'org_example' # str | 
start_date = 'start_date_example' # str | Start date for filtering (YYYY-MM-DD)
user_id = 'user_id_example' # str | 
aggregation = daily # str | Time aggregation level (hourly, daily, weekly) (optional) (default to daily)
group_by = 'day' # str |  (optional) (default to 'day')
mentor_id = 'mentor_id_example' # str | Filter by mentor unique ID (optional)

try:
    api_response = api_instance.ai_analytics_orgs_users_average_messages_per_session_list(end_date, org, start_date, user_id, aggregation=aggregation, group_by=group_by, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_average_messages_per_session_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_average_messages_per_session_list: %s\n" % e)
```
 ...
 **user_id** | **str**|  | 
 **aggregation** | **str**| Time aggregation level (hourly, daily, weekly) | [optional] [default to daily]
 **group_by** | **str**|  | [optional] [default to &#39;day&#39;]
 **mentor_id** | **str**| Filter by mentor unique ID | [optional] 

### Return type

[**List[MessageStatistics]**](MessageStatistics.md)
...
> Conversations ai_analytics_orgs_users_chat_history_create(org, user_id, conversations, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
...
org = 'org_example' # str | 
user_id = 'user_id_example' # str | 
conversations = iblai.Conversations() # Conversations | 
end_date = '2013-10-20' # date |  (optional)
filter_user_id = 'filter_user_id_example' # str |  (optional)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_chat_history_create(org, user_id, conversations, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_chat_history_create:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_chat_history_create: %s\n" % e)
```
...
> ai_analytics_orgs_users_chat_history_destroy(id, org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
...
try:
    api_instance.ai_analytics_orgs_users_chat_history_destroy(id, org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_chat_history_destroy: %s\n" % e)
```
...
> ChatHistoryFilterData ai_analytics_orgs_users_chat_history_filter_retrieve(org, user_id, end_date=end_date, mentor_id=mentor_id, monthly_range=monthly_range, start_date=start_date)
...
monthly_range = False # bool |  (optional) (default to False)
start_date = '2013-10-20' # date |  (optional)

try:
    api_response = api_instance.ai_analytics_orgs_users_chat_history_filter_retrieve(org, user_id, end_date=end_date, mentor_id=mentor_id, monthly_range=monthly_range, start_date=start_date)
 ...
 **monthly_range** | **bool**|  | [optional] [default to False]
 **start_date** | **date**|  | [optional] 
...
> PaginatedConversationsList ai_analytics_orgs_users_chat_history_list(org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, page=page, page_size=page_size, sentiment=sentiment, start_date=start_date, topics=topics)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_chat_history_list(org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, page=page, page_size=page_size, sentiment=sentiment, start_date=start_date, topics=topics)
...
> Conversations ai_analytics_orgs_users_chat_history_partial_update(id, org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics, patched_conversations=patched_conversations)
...
start_date = '2013-10-20' # date |  (optional)
topics = 'topics_example' # str |  (optional)
patched_conversations = iblai.PatchedConversations() # PatchedConversations |  (optional)

try:
    api_response = api_instance.ai_analytics_orgs_users_chat_history_partial_update(id, org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics, patched_conversations=patched_conversations)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_chat_history_partial_update:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_chat_history_partial_update: %s\n" % e)
```
 ...
 **start_date** | **date**|  | [optional] 
 **topics** | **str**|  | [optional] 
 **patched_conversations** | [**PatchedConversations**](PatchedConversations.md)|  | [optional] 
...
> Conversations ai_analytics_orgs_users_chat_history_retrieve(id, org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_chat_history_retrieve(id, org, user_id, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
...
> Conversations ai_analytics_orgs_users_chat_history_update(id, org, user_id, conversations, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_chat_history_update(id, org, user_id, conversations, end_date=end_date, filter_user_id=filter_user_id, mentor=mentor, sentiment=sentiment, start_date=start_date, topics=topics)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_chat_history_update:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_chat_history_update: %s\n" % e)
```
...
> List[ConversationVolume] ai_analytics_orgs_users_conversation_list(end_date, org, start_date, user_id, aggregation=aggregation, mentor_id=mentor_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_conversation_list(end_date, org, start_date, user_id, aggregation=aggregation, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_conversation_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_conversation_list: %s\n" % e)
```
...
[**List[ConversationVolume]**](ConversationVolume.md)
...
> ConversationSummary ai_analytics_orgs_users_conversation_summary_retrieve(org, user_id, group_by=group_by, mentor_id=mentor_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_conversation_summary_retrieve(org, user_id, group_by=group_by, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_conversation_summary_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_conversation_summary_retrieve: %s\n" % e)
```
...
> Cost ai_analytics_orgs_users_mentors_cost_retrieve(end_date, mentor_unique_id, org, start_date, user_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_mentors_cost_retrieve(end_date, mentor_unique_id, org, start_date, user_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_mentors_cost_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_mentors_cost_retrieve: %s\n" % e)
```
...
> List[TopicRecord] ai_analytics_orgs_users_most_discussed_topics_list(end_date, org, start_date, user_id, aggregation=aggregation, group_by=group_by, mentor_id=mentor_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_most_discussed_topics_list(end_date, org, start_date, user_id, aggregation=aggregation, group_by=group_by, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_most_discussed_topics_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_most_discussed_topics_list: %s\n" % e)
```
...
[**List[TopicRecord]**](TopicRecord.md)
...
user_id = 'user_id_example' # str | 
group_by = 'day' # str |  (optional) (default to 'day')
mentor_id = 'mentor_id_example' # str | Filter analytics by mentor unique ID (optional)

try:
    api_response = api_instance.ai_analytics_orgs_users_overview_summary_retrieve(org, user_id, group_by=group_by, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_overview_summary_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_overview_summary_retrieve: %s\n" % e)
```
 ...
 **user_id** | **str**|  | 
 **group_by** | **str**|  | [optional] [default to &#39;day&#39;]
 **mentor_id** | **str**| Filter analytics by mentor unique ID | [optional] 
...
> List[RatingRecord] ai_analytics_orgs_users_rating_summary_list(end_date, org, start_date, user_id, group_by=group_by)
...
start_date = 'start_date_example' # str | Start date for filtering (YYYY-MM-DD)
user_id = 'user_id_example' # str | 
group_by = day # str | Aggregation level (day or hour) (optional) (default to day)

try:
    api_response = api_instance.ai_analytics_orgs_users_rating_summary_list(end_date, org, start_date, user_id, group_by=group_by)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_rating_summary_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_rating_summary_list: %s\n" % e)
```
 ...
 **start_date** | **str**| Start date for filtering (YYYY-MM-DD) | 
 **user_id** | **str**|  | 
 **group_by** | **str**| Aggregation level (day or hour) | [optional] [default to day]

### Return type

[**List[RatingRecord]**](RatingRecord.md)
...
> List[TrendEntry] ai_analytics_orgs_users_registered_users_trend_list(end_date, org, start_date, user_id, aggregation=aggregation, group_by=group_by)
...
start_date = 'start_date_example' # str | Start date for filtering (YYYY-MM-DD)
user_id = 'user_id_example' # str | 
aggregation = daily # str | Time aggregation level (hourly, daily, weekly, monthly) (optional) (default to daily)
group_by = 'day' # str |  (optional) (default to 'day')

try:
    api_response = api_instance.ai_analytics_orgs_users_registered_users_trend_list(end_date, org, start_date, user_id, aggregation=aggregation, group_by=group_by)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_registered_users_trend_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_registered_users_trend_list: %s\n" % e)
```
 ...
 **start_date** | **str**| Start date for filtering (YYYY-MM-DD) | 
 **user_id** | **str**|  | 
 **aggregation** | **str**| Time aggregation level (hourly, daily, weekly, monthly) | [optional] [default to daily]
 **group_by** | **str**|  | [optional] [default to &#39;day&#39;]

### Return type

[**List[TrendEntry]**](TrendEntry.md)
...
> List[UserSentimentCountView] ai_analytics_orgs_users_sentiment_count_list(org, user_id, period=period)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_sentiment_count_list(org, user_id, period=period)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_sentiment_count_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_sentiment_count_list: %s\n" % e)
```
...
[**List[UserSentimentCountView]**](UserSentimentCountView.md)
...
> Cost ai_analytics_orgs_users_tenant_cost_retrieve(end_date, org, start_date, user_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_tenant_cost_retrieve(end_date, org, start_date, user_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_tenant_cost_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_tenant_cost_retrieve: %s\n" % e)
```
...
> List[StudentChatMessage] ai_analytics_orgs_users_top_students_by_chat_messages_list(org, user_id, group_by=group_by)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_top_students_by_chat_messages_list(org, user_id, group_by=group_by)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_top_students_by_chat_messages_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_top_students_by_chat_messages_list: %s\n" % e)
```
...
[**List[StudentChatMessage]**](StudentChatMessage.md)
...
> TopicStatisticsResponse ai_analytics_orgs_users_topic_overview_retrieve(org, user_id, mentor_id=mentor_id)
...
org = 'org_example' # str | 
user_id = 'user_id_example' # str | 
mentor_id = 'mentor_id_example' # str | Filter statistics by mentor unique ID (optional)

try:
    api_response = api_instance.ai_analytics_orgs_users_topic_overview_retrieve(org, user_id, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_topic_overview_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_topic_overview_retrieve: %s\n" % e)
```
 ...
 **org** | **str**|  | 
 **user_id** | **str**|  | 
 **mentor_id** | **str**| Filter statistics by mentor unique ID | [optional] 

### Return type

[**TopicStatisticsResponse**](TopicStatisticsResponse.md)
...
> PaginatedTopicStatisticsResponse ai_analytics_orgs_users_topic_statistics_retrieve(org, user_id, end_date=end_date, group_by=group_by, mentor_id=mentor_id, page=page, page_size=page_size, start_date=start_date)
...
org = 'org_example' # str | 
user_id = 'user_id_example' # str | 
end_date = 'end_date_example' # str | End date for filtering (YYYY-MM-DD) (optional)
group_by = 'day' # str |  (optional) (default to 'day')
mentor_id = 'mentor_id_example' # str | Filter by mentor unique ID (optional)
...
start_date = 'start_date_example' # str | Start date for filtering (YYYY-MM-DD) (optional)

try:
    api_response = api_instance.ai_analytics_orgs_users_topic_statistics_retrieve(org, user_id, end_date=end_date, group_by=group_by, mentor_id=mentor_id, page=page, page_size=page_size, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_topic_statistics_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_topic_statistics_retrieve: %s\n" % e)
```
...
[**PaginatedTopicStatisticsResponse**](PaginatedTopicStatisticsResponse.md)
...
> List[TopicSummaryView] ai_analytics_orgs_users_topics_summary_list(org, user_id, end_date=end_date, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_topics_summary_list(org, user_id, end_date=end_date, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_topics_summary_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_topics_summary_list: %s\n" % e)
```
...
[**List[TopicSummaryView]**](TopicSummaryView.md)
...
> List[UserChatByPeriod] ai_analytics_orgs_users_total_users_by_mentor_list(org, user_id, aggregation=aggregation, end_date=end_date, group_by=group_by, mentor_id=mentor_id, start_date=start_date)
...
org = 'org_example' # str | 
user_id = 'user_id_example' # str | 
aggregation = daily # str | Time aggregation level (hourly, daily) (optional) (default to daily)
end_date = 'end_date_example' # str | End date for filtering (YYYY-MM-DD) (optional)
group_by = 'day' # str |  (optional) (default to 'day')
mentor_id = 'mentor_id_example' # str | Filter by mentor unique ID (optional)
start_date = 'start_date_example' # str | Start date for filtering (YYYY-MM-DD) (optional)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_total_users_by_mentor_list(org, user_id, aggregation=aggregation, end_date=end_date, group_by=group_by, mentor_id=mentor_id, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_total_users_by_mentor_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_total_users_by_mentor_list: %s\n" % e)
```
 ...
 **org** | **str**|  | 
 **user_id** | **str**|  | 
 **aggregation** | **str**| Time aggregation level (hourly, daily) | [optional] [default to daily]
 **end_date** | **str**| End date for filtering (YYYY-MM-DD) | [optional] 
 **group_by** | **str**|  | [optional] [default to &#39;day&#39;]
 **mentor_id** | **str**| Filter by mentor unique ID | [optional] 
 **start_date** | **str**| Start date for filtering (YYYY-MM-DD) | [optional] 
...
[**List[UserChatByPeriod]**](UserChatByPeriod.md)
...
> List[ConversationMessage] ai_analytics_orgs_users_transcripts_list(org, user_id, end_date=end_date, mentor=mentor, start_date=start_date, topics=topics)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_transcripts_list(org, user_id, end_date=end_date, mentor=mentor, start_date=start_date, topics=topics)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_transcripts_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_transcripts_list: %s\n" % e)
```
...
> List[UserCountRecord] ai_analytics_orgs_users_usage_summary_list(end_date, org, start_date, user_id, group_by=group_by)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_usage_summary_list(end_date, org, start_date, user_id, group_by=group_by)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_usage_summary_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_usage_summary_list: %s\n" % e)
```
...
[**List[UserCountRecord]**](UserCountRecord.md)
...
> UserTrendByPeriod ai_analytics_orgs_users_user_cohorts_over_time_retrieve(end_date, org, start_date, user_id, aggregation=aggregation, mentor_id=mentor_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_user_cohorts_over_time_retrieve(end_date, org, start_date, user_id, aggregation=aggregation, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_user_cohorts_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_user_cohorts_over_time_retrieve: %s\n" % e)
```
...
[**UserTrendByPeriod**](UserTrendByPeriod.md)
...
> Cost ai_analytics_orgs_users_user_cost_retrieve(end_date, org, start_date, user_id, username)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_user_cost_retrieve(end_date, org, start_date, user_id, username)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_user_cost_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_user_cost_retrieve: %s\n" % e)
```
...
> List[UserChatFeedbackCount] ai_analytics_orgs_users_user_feedback_list(end_date, org, start_date, user_id, aggregation=aggregation, mentor_id=mentor_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_user_feedback_list(end_date, org, start_date, user_id, aggregation=aggregation, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_user_feedback_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_user_feedback_list: %s\n" % e)
```
...
[**List[UserChatFeedbackCount]**](UserChatFeedbackCount.md)
...
> PieChartData ai_analytics_orgs_users_user_metrics_pie_chart_retrieve(end_date, org, start_date, user_id, mentor_id=mentor_id)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_user_metrics_pie_chart_retrieve(end_date, org, start_date, user_id, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_user_metrics_pie_chart_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_user_metrics_pie_chart_retrieve: %s\n" % e)
```
...
> UserMetricsResponse ai_analytics_orgs_users_user_metrics_retrieve(org, user_id, group_by=group_by, mentor_id=mentor_id)
...
user_id = 'user_id_example' # str | 
group_by = 'day' # str |  (optional) (default to 'day')
mentor_id = 'mentor_id_example' # str | Filter metrics by mentor unique ID (optional)

try:
    api_response = api_instance.ai_analytics_orgs_users_user_metrics_retrieve(org, user_id, group_by=group_by, mentor_id=mentor_id)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_user_metrics_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_user_metrics_retrieve: %s\n" % e)
```
 ...
 **user_id** | **str**|  | 
 **group_by** | **str**|  | [optional] [default to &#39;day&#39;]
 **mentor_id** | **str**| Filter metrics by mentor unique ID | [optional] 

### Return type

[**UserMetricsResponse**](UserMetricsResponse.md)
...
> SentimentSummary ai_analytics_orgs_users_user_sentiment_retrieve(end_date, org, start_date, user_id, group_by=group_by)
...
try:
    api_response = api_instance.ai_analytics_orgs_users_user_sentiment_retrieve(end_date, org, start_date, user_id, group_by=group_by)
    print("The response of AiAnalyticsApi->ai_analytics_orgs_users_user_sentiment_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_orgs_users_user_sentiment_retrieve: %s\n" % e)
```
...
[**SentimentSummary**](SentimentSummary.md)
...
> OvertimeWithChangeInfo ai_analytics_overview_orgs_active_users_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_overview_orgs_active_users_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_overview_orgs_active_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_overview_orgs_active_users_retrieve: %s\n" % e)
```
...
> Average ai_analytics_overview_orgs_average_grade_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_overview_orgs_average_grade_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_overview_orgs_average_grade_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_overview_orgs_average_grade_retrieve: %s\n" % e)
```
...
> CourseCompletionSummaryOvertime ai_analytics_overview_orgs_courses_completions_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_overview_orgs_courses_completions_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_overview_orgs_courses_completions_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_overview_orgs_courses_completions_retrieve: %s\n" % e)
```
...
> PerlearnerUserList ai_analytics_overview_orgs_learners_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page, search=search)
...
try:
    api_response = api_instance.ai_analytics_overview_orgs_learners_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page, search=search)
    print("The response of AiAnalyticsApi->ai_analytics_overview_orgs_learners_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_overview_orgs_learners_retrieve: %s\n" % e)
```
...
> TimeSpentPerCourse ai_analytics_overview_orgs_most_active_courses_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_overview_orgs_most_active_courses_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, length=length, page=page, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_overview_orgs_most_active_courses_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_overview_orgs_most_active_courses_retrieve: %s\n" % e)
```
...
> OvertimeWithChangeInfo ai_analytics_overview_orgs_registered_users_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_overview_orgs_registered_users_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_overview_orgs_registered_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_overview_orgs_registered_users_retrieve: %s\n" % e)
```
...
> Average ai_analytics_performance_orgs_courses_grading_average_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_performance_orgs_courses_grading_average_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_average_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_average_retrieve: %s\n" % e)
```
...
> AvgCourseGradeWithCutoff ai_analytics_performance_orgs_courses_grading_average_with_cutoff_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_performance_orgs_courses_grading_average_with_cutoff_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_average_with_cutoff_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_average_with_cutoff_retrieve: %s\n" % e)
```
...
> CourseGradingDetail ai_analytics_performance_orgs_courses_grading_detail_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_performance_orgs_courses_grading_detail_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_detail_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_detail_retrieve: %s\n" % e)
```
...
> GradingPerUser ai_analytics_performance_orgs_courses_grading_per_learner_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_performance_orgs_courses_grading_per_learner_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_per_learner_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_per_learner_retrieve: %s\n" % e)
```
...
> CourseGradeSummary ai_analytics_performance_orgs_courses_grading_summary_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_performance_orgs_courses_grading_summary_retrieve(course_id, org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_summary_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_performance_orgs_courses_grading_summary_retrieve: %s\n" % e)
```
...
> Average ai_analytics_performance_orgs_grading_average_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_performance_orgs_grading_average_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_performance_orgs_grading_average_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_performance_orgs_grading_average_retrieve: %s\n" % e)
```
...
> PerformanceGradesPerCourse ai_analytics_performance_orgs_grading_per_course_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
...
try:
    api_response = api_instance.ai_analytics_performance_orgs_grading_per_course_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page)
    print("The response of AiAnalyticsApi->ai_analytics_performance_orgs_grading_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_performance_orgs_grading_per_course_retrieve: %s\n" % e)
```
...
> NewPerLearnerList ai_analytics_perlearner_orgs_learners_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, is_enrolled=is_enrolled, length=length, location=location, page=page, platform=platform, program=program, search=search, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_learners_retrieve(org, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, is_enrolled=is_enrolled, length=length, location=location, page=page, platform=platform, program=program, search=search, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_learners_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_learners_retrieve: %s\n" % e)
```
...
> ActivityAPI ai_analytics_perlearner_orgs_users_activity_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_activity_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_activity_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_activity_retrieve: %s\n" % e)
```
...
> PerlearnerGradeWithCutOff ai_analytics_perlearner_orgs_users_courses_grading_cutoffs_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_grading_cutoffs_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_grading_cutoffs_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_grading_cutoffs_retrieve: %s\n" % e)
```
...
> DetailedGradeView ai_analytics_perlearner_orgs_users_courses_grading_detail_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_grading_detail_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_grading_detail_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_grading_detail_retrieve: %s\n" % e)
```
...
> PerlearnerGradeSummary ai_analytics_perlearner_orgs_users_courses_grading_summary_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_grading_summary_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_grading_summary_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_grading_summary_retrieve: %s\n" % e)
```
...
> Value ai_analytics_perlearner_orgs_users_courses_overview_engagement_index_retrieve(course_id, org, user_id)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_overview_engagement_index_retrieve(course_id, org, user_id)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_engagement_index_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_engagement_index_retrieve: %s\n" % e)
```
...
> PerlearnerGradeWithCutOff ai_analytics_perlearner_orgs_users_courses_overview_grade_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_overview_grade_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_grade_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_grade_retrieve: %s\n" % e)
```
...
> Value ai_analytics_perlearner_orgs_users_courses_overview_performance_index_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_overview_performance_index_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_performance_index_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_performance_index_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_perlearner_orgs_users_courses_overview_time_over_time_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_overview_time_over_time_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_time_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_overview_time_over_time_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_perlearner_orgs_users_courses_videos_over_time_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_videos_over_time_retrieve(course_id, org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_videos_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_videos_over_time_retrieve: %s\n" % e)
```
...
> PerLearnerCourseVideosWatched ai_analytics_perlearner_orgs_users_courses_videos_retrieve(course_id, org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_courses_videos_retrieve(course_id, org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_videos_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_courses_videos_retrieve: %s\n" % e)
```
...
> PerlearnerGradingPerCourseAPI ai_analytics_perlearner_orgs_users_grades_per_course_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_grades_per_course_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_grades_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_grades_per_course_retrieve: %s\n" % e)
```
...
> LearnerInformationAPI ai_analytics_perlearner_orgs_users_info_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform, meta=meta, search=search)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_info_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform, meta=meta, search=search)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_info_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_info_retrieve: %s\n" % e)
```
...
> PerLearnerLastAccess ai_analytics_perlearner_orgs_users_last_access_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_last_access_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_last_access_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_last_access_retrieve: %s\n" % e)
```
...
> Value ai_analytics_perlearner_orgs_users_overview_engagement_index_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_overview_engagement_index_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_engagement_index_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_engagement_index_retrieve: %s\n" % e)
```
...
> Average ai_analytics_perlearner_orgs_users_overview_grades_average_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_overview_grades_average_retrieve(org, user_id, department_id=department_id, format=format, include_main_platform=include_main_platform)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_grades_average_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_grades_average_retrieve: %s\n" % e)
```
...
> Value ai_analytics_perlearner_orgs_users_overview_performance_index_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_overview_performance_index_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_performance_index_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_performance_index_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_perlearner_orgs_users_overview_time_over_time_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_overview_time_over_time_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_time_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_overview_time_over_time_retrieve: %s\n" % e)
```
...
> PerlearnerUserList ai_analytics_perlearner_orgs_users_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page, search=search)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_retrieve(org, department_id=department_id, format=format, include_main_platform=include_main_platform, length=length, page=page, search=search)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_retrieve: %s\n" % e)
```
...
> OverTimeWithTotal ai_analytics_perlearner_orgs_users_videos_over_time_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_videos_over_time_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_videos_over_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_videos_over_time_retrieve: %s\n" % e)
```
...
> PerlearnerEngagementVideosWatchedPerCourse ai_analytics_perlearner_orgs_users_videos_per_course_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_perlearner_orgs_users_videos_per_course_retrieve(org, user_id, department_id=department_id, end_date=end_date, format=format, include_main_platform=include_main_platform, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_perlearner_orgs_users_videos_per_course_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_perlearner_orgs_users_videos_per_course_retrieve: %s\n" % e)
```
...
> GroupList ai_analytics_user_groups_orgs_retrieve(org, department_id=department_id, end_date=end_date, format=format, groups=groups, include_main_platform=include_main_platform, is_enrolled=is_enrolled, length=length, location=location, page=page, pathway=pathway, program=program, start_date=start_date)
...
try:
    api_response = api_instance.ai_analytics_user_groups_orgs_retrieve(org, department_id=department_id, end_date=end_date, format=format, groups=groups, include_main_platform=include_main_platform, is_enrolled=is_enrolled, length=length, location=location, page=page, pathway=pathway, program=program, start_date=start_date)
    print("The response of AiAnalyticsApi->ai_analytics_user_groups_orgs_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->ai_analytics_user_groups_orgs_retrieve: %s\n" % e)
```
...
> ConversationsChart analytics_conversations_retrieve(date_filter=date_filter, end_date=end_date, granularity=granularity, mentor_unique_id=mentor_unique_id, metric=metric, platform_key=platform_key, start_date=start_date)
...
metric = conversations # str | * `conversations` - Conversations over time * `headline` - Headline metrics for conversations (avg messages per conversation, avg rating) (optional) (default to conversations)
platform_key = 'platform_key_example' # str |  (optional)
start_date = '2013-10-20' # date |  (optional)

try:
    api_response = api_instance.analytics_conversations_retrieve(date_filter=date_filter, end_date=end_date, granularity=granularity, mentor_unique_id=mentor_unique_id, metric=metric, platform_key=platform_key, start_date=start_date)
    print("The response of AiAnalyticsApi->analytics_conversations_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_conversations_retrieve: %s\n" % e)
```
 ...
 **metric** | **str**| * &#x60;conversations&#x60; - Conversations over time * &#x60;headline&#x60; - Headline metrics for conversations (avg messages per conversation, avg rating) | [optional] [default to conversations]
 **platform_key** | **str**|  | [optional] 
 **start_date** | **date**|  | [optional] 

### Return type

[**ConversationsChart**](ConversationsChart.md)
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_financial_details_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_financial_details_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_financial_invoice_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_financial_invoice_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_financial_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_financial_retrieve: %s\n" % e)
```
...
> LearnerDetailsResponse analytics_learner_details_retrieve(username, date_filter=date_filter, end_date=end_date, granularity=granularity, mentor_unique_id=mentor_unique_id, metrics=metrics, overtime=overtime, platform_key=platform_key, start_date=start_date)
...
overtime = False # bool | Include overtime metrics for time_spent data (default: false) (optional) (default to False)
platform_key = 'platform_key_example' # str |  (optional)
start_date = '2013-10-20' # date |  (optional)

try:
    api_response = api_instance.analytics_learner_details_retrieve(username, date_filter=date_filter, end_date=end_date, granularity=granularity, mentor_unique_id=mentor_unique_id, metrics=metrics, overtime=overtime, platform_key=platform_key, start_date=start_date)
    print("The response of AiAnalyticsApi->analytics_learner_details_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_learner_details_retrieve: %s\n" % e)
```
 ...
 **overtime** | **bool**| Include overtime metrics for time_spent data (default: false) | [optional] [default to False]
 **platform_key** | **str**|  | [optional] 
 **start_date** | **date**|  | [optional] 

### Return type

[**LearnerDetailsResponse**](LearnerDetailsResponse.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Learner profile with requested analytics data |  -  |
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_learners_list_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_learners_list_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_learners_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_learners_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_messages_details_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_messages_details_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_messages_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_messages_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_ratings_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_ratings_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_sessions_details_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_sessions_details_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_sessions_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_sessions_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_time_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_time_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_topics_details_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_topics_details_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_topics_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_topics_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_users_details_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_users_details_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->analytics_users_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->analytics_users_retrieve: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->get_content_analytics:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->get_content_analytics: %s\n" % e)
```
...
try:
    ...
    print("The response of AiAnalyticsApi->get_content_details:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling AiAnalyticsApi->get_content_details: %s\n" % e)
```
