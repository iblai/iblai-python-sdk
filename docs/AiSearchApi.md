...
> V2GlobalMentorSearchResponse v2_global_mentor_search(alphabetical=alphabetical, category=category, created_by=created_by, featured=featured, include_main_public_mentors=include_main_public_mentors, limit=limit, llm=llm, offset=offset, order_by=order_by, order_direction=order_direction, platform_key=platform_key, query=query, starred=starred, subjects=subjects, tenant=tenant, types=types, visibility=visibility)
...
# Create an instance of the API class
api_instance = iblai.AiSearchApi(api_client)
alphabetical = False # bool | Sort alphabetically by name (shorthand for order_by='name'). When true, overrides order_by parameter. (optional) (default to False)
...
featured = True # bool | Filter by featured status (true/false) (optional)
...
order_by = 'order_by_example' # str | Field to sort results by ('created_at', '-created_at', 'recently_accessed_at', '-recently_accessed_at', 'name', '-name'). Use '-' prefix for descending order. (optional)
order_direction = 'desc' # str | Sort direction ('asc' or 'desc'). Only used if order_by doesn't start with '-'. Defaults to 'desc'. (optional) (default to 'desc')
...
starred = True # bool | Filter by starred status (true/false) - only for authenticated users (optional)
subjects = 'subjects_example' # str | Mentor subject filter (optional)
tenant = 'tenant_example' # str | Tenant key(s) (CSV). Can be used as a filter for multiple tenants, or as an alias for 'platform_key' (backward compatibility). (optional)
...
try:
    # Search and filter AI mentors across the platform
    api_response = api_instance.v2_global_mentor_search(alphabetical=alphabetical, category=category, created_by=created_by, featured=featured, include_main_public_mentors=include_main_public_mentors, limit=limit, llm=llm, offset=offset, order_by=order_by, order_direction=order_direction, platform_key=platform_key, query=query, starred=starred, subjects=subjects, tenant=tenant, types=types, visibility=visibility)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **alphabetical** | **bool**| Sort alphabetically by name (shorthand for order_by&#x3D;&#39;name&#39;). When true, overrides order_by parameter. | [optional] [default to False]
 ...
 **featured** | **bool**| Filter by featured status (true/false) | [optional] 
 ...
 **order_by** | **str**| Field to sort results by (&#39;created_at&#39;, &#39;-created_at&#39;, &#39;recently_accessed_at&#39;, &#39;-recently_accessed_at&#39;, &#39;name&#39;, &#39;-name&#39;). Use &#39;-&#39; prefix for descending order. | [optional] 
 **order_direction** | **str**| Sort direction (&#39;asc&#39; or &#39;desc&#39;). Only used if order_by doesn&#39;t start with &#39;-&#39;. Defaults to &#39;desc&#39;. | [optional] [default to &#39;desc&#39;]
 ...
 **starred** | **bool**| Filter by starred status (true/false) - only for authenticated users | [optional] 
 **subjects** | **str**| Mentor subject filter | [optional] 
 **tenant** | **str**| Tenant key(s) (CSV). Can be used as a filter for multiple tenants, or as an alias for &#39;platform_key&#39; (backward compatibility). | [optional] 
...
> V2PersonalizedMentorsResponse v2_personalized_mentors(audience=audience, category=category, featured=featured, limit=limit, llm=llm, offset=offset, order_by=order_by, order_direction=order_direction, platform_key=platform_key, query=query, return_facet=return_facet, starred=starred, tags=tags, tenant=tenant, username=username, visibility=visibility)
...
featured = True # bool | Filter by featured status (true/false) (optional)
limit = 56 # int | Number of results per page (optional)
llm = 'llm_example' # str | LLM provider filter (frontend uses 'llm', backend maps to 'llm_provider') (optional)
offset = 56 # int | Number of results to skip (optional)
...
starred = True # bool | Filter by starred status (true/false) (optional)
tags = ['tags_example'] # List[str] | Filter by tags (optional)
...
try:
    # Get mentors created by a specific user
    api_response = api_instance.v2_personalized_mentors(audience=audience, category=category, featured=featured, limit=limit, llm=llm, offset=offset, order_by=order_by, order_direction=order_direction, platform_key=platform_key, query=query, return_facet=return_facet, starred=starred, tags=tags, tenant=tenant, username=username, visibility=visibility)
 ...
 **featured** | **bool**| Filter by featured status (true/false) | [optional] 
 **limit** | **int**| Number of results per page | [optional] 
 **llm** | **str**| LLM provider filter (frontend uses &#39;llm&#39;, backend maps to &#39;llm_provider&#39;) | [optional] 
 **offset** | **int**| Number of results to skip | [optional] 
 ...
 **starred** | **bool**| Filter by starred status (true/false) | [optional] 
 **tags** | [**List[str]**](str.md)| Filter by tags | [optional] 
