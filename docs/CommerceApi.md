...
[**service_platforms_stripe_connect_dashboard_retrieve**](CommerceApi.md#service_platforms_stripe_connect_dashboard_retrieve) | **GET** /api/service/platforms/{platform_key}/stripe/connect/dashboard/ | 
[**service_platforms_stripe_connect_destroy**](CommerceApi.md#service_platforms_stripe_connect_destroy) | **DELETE** /api/service/platforms/{platform_key}/stripe/connect/ | 
[**service_platforms_stripe_connect_onboard_create**](CommerceApi.md#service_platforms_stripe_connect_onboard_create) | **POST** /api/service/platforms/{platform_key}/stripe/connect/onboard/ | 
[**service_platforms_stripe_connect_onboard_refresh_create**](CommerceApi.md#service_platforms_stripe_connect_onboard_refresh_create) | **POST** /api/service/platforms/{platform_key}/stripe/connect/onboard/refresh/ | 
[**service_platforms_stripe_connect_status_retrieve**](CommerceApi.md#service_platforms_stripe_connect_status_retrieve) | **GET** /api/service/platforms/{platform_key}/stripe/connect/status/ | 
...
> StripeConnectDashboardLink service_platforms_stripe_connect_dashboard_retrieve(platform_key)
...
try:
    api_response = api_instance.service_platforms_stripe_connect_dashboard_retrieve(platform_key)
    print("The response of CommerceApi->service_platforms_stripe_connect_dashboard_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CommerceApi->service_platforms_stripe_connect_dashboard_retrieve: %s\n" % e)
```
...
[**StripeConnectDashboardLink**](StripeConnectDashboardLink.md)
...
> Dict[str, object] service_platforms_stripe_connect_destroy(platform_key)
...
try:
    api_response = api_instance.service_platforms_stripe_connect_destroy(platform_key)
    print("The response of CommerceApi->service_platforms_stripe_connect_destroy:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CommerceApi->service_platforms_stripe_connect_destroy: %s\n" % e)
```
...
> StripeConnectOnboardResponse service_platforms_stripe_connect_onboard_create(platform_key, stripe_connect_onboard)
...
api_instance = iblai.CommerceApi(api_client)
platform_key = 'platform_key_example' # str | 
stripe_connect_onboard = iblai.StripeConnectOnboard() # StripeConnectOnboard | 

try:
    api_response = api_instance.service_platforms_stripe_connect_onboard_create(platform_key, stripe_connect_onboard)
    print("The response of CommerceApi->service_platforms_stripe_connect_onboard_create:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CommerceApi->service_platforms_stripe_connect_onboard_create: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **platform_key** | **str**|  | 
 **stripe_connect_onboard** | [**StripeConnectOnboard**](StripeConnectOnboard.md)|  | 

### Return type

[**StripeConnectOnboardResponse**](StripeConnectOnboardResponse.md)
...
> StripeConnectOnboardResponse service_platforms_stripe_connect_onboard_refresh_create(platform_key, stripe_connect_onboard)
...
try:
    api_response = api_instance.service_platforms_stripe_connect_onboard_refresh_create(platform_key, stripe_connect_onboard)
    print("The response of CommerceApi->service_platforms_stripe_connect_onboard_refresh_create:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CommerceApi->service_platforms_stripe_connect_onboard_refresh_create: %s\n" % e)
```
...
> StripeConnectStatus service_platforms_stripe_connect_status_retrieve(platform_key)
...
try:
    api_response = api_instance.service_platforms_stripe_connect_status_retrieve(platform_key)
    print("The response of CommerceApi->service_platforms_stripe_connect_status_retrieve:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CommerceApi->service_platforms_stripe_connect_status_retrieve: %s\n" % e)
```
...
[**StripeConnectStatus**](StripeConnectStatus.md)
