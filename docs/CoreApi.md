...
[**core_rbac_teams_access_create**](CoreApi.md#core_rbac_teams_access_create) | **POST** /api/core/rbac/teams/access/ | Control which RbacGroups and/or Users have access to a UserGroup (team) and with what Role
[**core_rbac_teams_access_list**](CoreApi.md#core_rbac_teams_access_list) | **GET** /api/core/rbac/teams/access/ | Get usergroup access status
...
[**core_user_groups_create**](CoreApi.md#core_user_groups_create) | **POST** /api/core/user-groups/ | Create UserGroup
[**core_user_groups_create2**](CoreApi.md#core_user_groups_create2) | **POST** /api/core/user_groups/ | 
[**core_user_groups_destroy**](CoreApi.md#core_user_groups_destroy) | **DELETE** /api/core/user-groups/{id}/ | Delete UserGroup
[**core_user_groups_destroy2**](CoreApi.md#core_user_groups_destroy2) | **DELETE** /api/core/user_groups/ | 
...
[**core_user_groups_list**](CoreApi.md#core_user_groups_list) | **GET** /api/core/user-groups/ | List UserGroups
[**core_user_groups_partial_update**](CoreApi.md#core_user_groups_partial_update) | **PATCH** /api/core/user-groups/{id}/ | Partially update UserGroup
[**core_user_groups_retrieve**](CoreApi.md#core_user_groups_retrieve) | **GET** /api/core/user-groups/{id}/ | Retrieve UserGroup
[**core_user_groups_retrieve2**](CoreApi.md#core_user_groups_retrieve2) | **GET** /api/core/user_groups/ | 
[**core_user_groups_update**](CoreApi.md#core_user_groups_update) | **PUT** /api/core/user-groups/{id}/ | Update UserGroup
...
> core_orgs_redirect_tokens_delete_destroy(org, redirect_token, mentor_unique_id=mentor_unique_id)
...
mentor_unique_id = 'mentor_unique_id_example' # str | Optional mentor unique ID for RBAC ownership check (optional)

try:
    api_instance.core_orgs_redirect_tokens_delete_destroy(org, redirect_token, mentor_unique_id=mentor_unique_id)
except Exception as e:
...
> PaginatedRbacRoleList core_rbac_roles_list(include_global_roles=include_global_roles, name=name, page=page, page_size=page_size, platform_key=platform_key)
...
# Create an instance of the API class
api_instance = iblai.CoreApi(api_client)
include_global_roles = False # bool | Include global roles (optional) (default to False)
...
try:
    # List RBAC roles
    api_response = api_instance.core_rbac_roles_list(include_global_roles=include_global_roles, name=name, page=page, page_size=page_size, platform_key=platform_key)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **include_global_roles** | **bool**| Include global roles | [optional] [default to False]
...
# **core_rbac_teams_access_create**
> UserGroupPolicy core_rbac_teams_access_create(user_group_policy)
...
# Create an instance of the API class
api_instance = iblai.CoreApi(api_client)
user_group_policy = iblai.UserGroupPolicy() # UserGroupPolicy | 

try:
    # Control which RbacGroups and/or Users have access to a UserGroup (team) and with what Role
    api_response = api_instance.core_rbac_teams_access_create(user_group_policy)
    print("The response of CoreApi->core_rbac_teams_access_create:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CoreApi->core_rbac_teams_access_create: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user_group_policy** | [**UserGroupPolicy**](UserGroupPolicy.md)|  | 

### Return type

[**UserGroupPolicy**](UserGroupPolicy.md)
...
# **core_rbac_teams_access_list**
> List[UserGroupPolicy] core_rbac_teams_access_list(platform_key, usergroup_id)
...
# Create an instance of the API class
api_instance = iblai.CoreApi(api_client)
platform_key = 'platform_key_example' # str | Platform key where the usergroup belongs
usergroup_id = 56 # int | ID of the usergroup to get access information for

try:
    # Get usergroup access status
    api_response = api_instance.core_rbac_teams_access_list(platform_key, usergroup_id)
    print("The response of CoreApi->core_rbac_teams_access_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CoreApi->core_rbac_teams_access_list: %s\n" % e)
```
 ...
 **usergroup_id** | **int**| ID of the usergroup to get access information for | 

### Return type

[**List[UserGroupPolicy]**](UserGroupPolicy.md)
...
> UserGroup core_user_groups_create(user_group)
...
# Create an instance of the API class
api_instance = iblai.CoreApi(api_client)
user_group = iblai.UserGroup() # UserGroup | 

try:
    # Create UserGroup
    api_response = api_instance.core_user_groups_create(user_group)
    print("The response of CoreApi->core_user_groups_create:\n")
    pprint(api_response)
except Exception as e:
...
try:
    api_instance.core_user_groups_create2()
except Exception as e:
    print("Exception when calling CoreApi->core_user_groups_create2: %s\n" % e)
```
...
try:
    # Delete UserGroup
    api_instance.core_user_groups_destroy(id)
except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | UserGroup deleted successfully |  -  |
...
try:
    api_instance.core_user_groups_destroy2()
except Exception as e:
    print("Exception when calling CoreApi->core_user_groups_destroy2: %s\n" % e)
```
...
# **core_user_groups_list**
> PaginatedUserGroupList core_user_groups_list(include_users=include_users, name=name, page=page, page_size=page_size, platform_key=platform_key, required_action=required_action, with_permissions=with_permissions)
...
# Create an instance of the API class
api_instance = iblai.CoreApi(api_client)
include_users = False # bool | Include user information in response (default: false for performance) (optional) (default to False)
name = 'name_example' # str | Fuzzy search by group name (optional)
page = 56 # int | A page number within the paginated result set. (optional)
page_size = 56 # int | Number of results to return per page. (optional)
platform_key = 'platform_key_example' # str | Filter groups by platform key (optional)
required_action = 'Ibl.Core/UserGroups/read' # str | Return user groups (teams) you have this action on (optional) (default to 'Ibl.Core/UserGroups/read')
with_permissions = False # bool | Include object-level permissions in response (optional) (default to False)

try:
    # List UserGroups
    api_response = api_instance.core_user_groups_list(include_users=include_users, name=name, page=page, page_size=page_size, platform_key=platform_key, required_action=required_action, with_permissions=with_permissions)
    print("The response of CoreApi->core_user_groups_list:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CoreApi->core_user_groups_list: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **include_users** | **bool**| Include user information in response (default: false for performance) | [optional] [default to False]
 **name** | **str**| Fuzzy search by group name | [optional] 
 **page** | **int**| A page number within the paginated result set. | [optional] 
 **page_size** | **int**| Number of results to return per page. | [optional] 
 **platform_key** | **str**| Filter groups by platform key | [optional] 
 **required_action** | **str**| Return user groups (teams) you have this action on | [optional] [default to &#39;Ibl.Core/UserGroups/read&#39;]
 **with_permissions** | **bool**| Include object-level permissions in response | [optional] [default to False]

### Return type

[**PaginatedUserGroupList**](PaginatedUserGroupList.md)
...
# **core_user_groups_partial_update**
> UserGroup core_user_groups_partial_update(id, patched_user_group=patched_user_group)
...
api_instance = iblai.CoreApi(api_client)
id = 56 # int | A unique integer value identifying this User Group.
patched_user_group = iblai.PatchedUserGroup() # PatchedUserGroup |  (optional)

try:
    # Partially update UserGroup
    api_response = api_instance.core_user_groups_partial_update(id, patched_user_group=patched_user_group)
    print("The response of CoreApi->core_user_groups_partial_update:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CoreApi->core_user_groups_partial_update: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this User Group. | 
 **patched_user_group** | [**PatchedUserGroup**](PatchedUserGroup.md)|  | [optional] 
...
> UserGroup core_user_groups_retrieve(id)
...
try:
    # Retrieve UserGroup
    api_response = api_instance.core_user_groups_retrieve(id)
    print("The response of CoreApi->core_user_groups_retrieve:\n")
    pprint(api_response)
except Exception as e:
...
try:
    api_instance.core_user_groups_retrieve2()
except Exception as e:
    print("Exception when calling CoreApi->core_user_groups_retrieve2: %s\n" % e)
```
...
# **core_user_groups_update**
> UserGroup core_user_groups_update(id, user_group)
...
try:
    # Update UserGroup
    api_response = api_instance.core_user_groups_update(id, user_group)
    print("The response of CoreApi->core_user_groups_update:\n")
    pprint(api_response)
except Exception as e:
    print("Exception when calling CoreApi->core_user_groups_update: %s\n" % e)
```
