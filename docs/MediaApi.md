...
------------- | ------------- | -------------
[**media_orgs_users_media_media_resources_by_item_retrieve**](MediaApi.md#media_orgs_users_media_media_resources_by_item_retrieve) | **GET** /api/media/orgs/{org}/users/{user_id}/media/media-resources/by_item/ | 
[**media_orgs_users_media_media_resources_create**](MediaApi.md#media_orgs_users_media_media_resources_create) | **POST** /api/media/orgs/{org}/users/{user_id}/media/media-resources/ | 
[**media_orgs_users_media_media_resources_destroy**](MediaApi.md#media_orgs_users_media_media_resources_destroy) | **DELETE** /api/media/orgs/{org}/users/{user_id}/media/media-resources/{id}/ | 
[**media_orgs_users_media_media_resources_list**](MediaApi.md#media_orgs_users_media_media_resources_list) | **GET** /api/media/orgs/{org}/users/{user_id}/media/media-resources/ | 
[**media_orgs_users_media_media_resources_partial_update**](MediaApi.md#media_orgs_users_media_media_resources_partial_update) | **PATCH** /api/media/orgs/{org}/users/{user_id}/media/media-resources/{id}/ | 
[**media_orgs_users_media_media_resources_retrieve**](MediaApi.md#media_orgs_users_media_media_resources_retrieve) | **GET** /api/media/orgs/{org}/users/{user_id}/media/media-resources/{id}/ | 
[**media_orgs_users_media_media_resources_search_retrieve**](MediaApi.md#media_orgs_users_media_media_resources_search_retrieve) | **GET** /api/media/orgs/{org}/users/{user_id}/media/media-resources/search/ | 
[**media_orgs_users_media_media_resources_update**](MediaApi.md#media_orgs_users_media_media_resources_update) | **PUT** /api/media/orgs/{org}/users/{user_id}/media/media-resources/{id}/ | 
...
api_instance = iblai.MediaApi(api_client)
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_by_item_retrieve: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_create: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_destroy: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_list: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_partial_update: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_retrieve: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_search_retrieve: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling MediaApi->media_orgs_users_media_media_resources_update: %s\n" % e)
```
