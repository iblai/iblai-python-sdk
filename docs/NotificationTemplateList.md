...
**source_platform** | **str** | Platform key of the template source (main or tenant) | [readonly] 
...
**is_custom** | **bool** | True if this is a custom notification type | [readonly] [default to False]
...
**spas** | **str** | SPAs (Single Page Apps) that can use this template | [readonly] 
**allowed_channels** | **str** | Channels this template can be delivered via (email, push, etc.) | [readonly] 
