...
**enable_offline_mode** | **bool** | Allow this mentor to be used offline with local LLMs | [optional] 
**metadata** | **object** |  | [optional] 
**enable_moderation** | **bool** |  | [optional] 
**enable_multi_query_rag** | **bool** |  | [optional] 
**enable_prompt_caching** | **bool** | Enable prompt caching for Anthropic models to reduce latency and cost. This disabled RAG and other dynamic parts of system prompt such as memory, current datetime, etc. Use with caution | [optional] 
...
**study_mode_prompt** | **str** | Prompt to be used to guide the user through their studies when study mode tool is enabled. | [optional] 
...
**starter_prompts** | [**StarterPromptsB04Enum**](StarterPromptsB04Enum.md) | Type of starter prompts to show: guided_prompt or suggested_prompt.  * &#x60;guided_prompt&#x60; - Guided Prompt * &#x60;suggested_prompt&#x60; - Suggested Prompt | [optional] 
...
**show_explore_mentors** | **bool** | Show explore mentors option. | [optional] 
**embed_icon_selection_data** | **object** | Stores embedded icon selection data for the mentor widget. | [optional] 
