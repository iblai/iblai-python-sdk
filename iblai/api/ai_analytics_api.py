...
class AiAnalyticsApi:
    ...
    def ai_analytics_orgs_users_chat_history_list(
        ...
        user_id2: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _ai_analytics_orgs_users_chat_history_list_serialize(
        ...
        if user_id2 is not None:
            ...
            _query_params.append(('user_id', user_id2))
    ...
    def ai_analytics_orgs_users_chat_history_retrieve(
        self,
        id: Annotated[StrictStr, Field(description="A UUID string identifying this session.")],
        org: StrictStr,
        user_id: StrictStr,
        end_date: Optional[date] = None,
        mentor: Optional[StrictStr] = None,
        ...
        :param id: A UUID string identifying this session. (required)
        :type id: str
        :param org: (required)
        :type org: str
        :param user_id: (required)
