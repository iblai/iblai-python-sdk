...
class AiIndexApi:
    ...
    def ai_index_orgs_users_documents_train_create(
        ...
        github_access_token: Annotated[Optional[StrictStr], Field(description="GitHub access token with repo scope. Required for private repositories.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param github_access_token: GitHub access token with repo scope. Required for private repositories.
    ...
    def _ai_index_orgs_users_documents_train_create_serialize(
        ...
        if github_access_token is not None:
            _form_params.append(('github_access_token', github_access_token))
        # process the body parameter
