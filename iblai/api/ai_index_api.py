...
class AiIndexApi:
    ...
    @validate_call
    def ai_index_orgs_users_resource_data_scrapped_retrieve2(
        self,
        org: StrictStr,
        ...
        _param = self._ai_index_orgs_users_resource_data_scrapped_retrieve2_serialize(
            org=org,
    ...
    def _ai_index_orgs_users_resource_data_scrapped_retrieve2_serialize(
        self,
        org,
        resource_id,
        user_id,
