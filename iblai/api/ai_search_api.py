...
class AiSearchApi:
    ...
    def v2_global_mentor_search(
        ...
        tenant: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description="Tenant key(s) (CSV). Can be used as a filter for multiple tenants, or as an alias for 'platform_key' in authenticated requests (backward compatibility).")] = None,
        ...
        :type subjects: str
        :param tenant: Tenant key(s) (CSV). Can be used as a filter for multiple tenants, or as an alias for 'platform_key' in authenticated requests (backward compatibility).
        :type tenant: str
