...
class MonitoringApi:
    ...
    @validate_call
    def monitoring_connectors_retrieve(
        self,
        ...
        _param = self._monitoring_connectors_retrieve_serialize(
    ...
    def _monitoring_connectors_retrieve_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/monitoring/connectors/',
