...
class AddMentorToDisclaimer(BaseModel):
    """
    ...
    """ # noqa: E501
    mentor_id: Annotated[str, Field(strict=True, max_length=255)] = Field(description="The unique_id of the mentor to add to the disclaimer.")
