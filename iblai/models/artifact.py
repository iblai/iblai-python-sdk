...
class Artifact(BaseModel):
    ...
    current_version_number: StrictInt = Field(description="Version number of the current version")
    version_count: StrictInt = Field(description="Total number of versions for this artifact")
    __properties: ClassVar[List[str]] = ["id", "title", "content", "file_extension", "chat_message", "llm_name", "llm_provider", "date_created", "date_updated", "metadata", "username", "session_id", "current_version_number", "version_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_version_number": obj.get("current_version_number"),
