...
class Artifact(BaseModel):
    ...
    content: StrictStr = Field(description="Content of the artifact")
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "content", "file_extension", "llm_name", "llm_provider", "date_created", "date_updated", "metadata", "username", "session_id", "current_version_number", "version_count"]
