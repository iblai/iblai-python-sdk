...
class AssumedKnowledge(BaseModel):
    """
    AssumedKnowledge
    """ # noqa: E501
    levels: List[AssumedKnowledgeLevel]
    __properties: ClassVar[List[str]] = ["levels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "levels": [AssumedKnowledgeLevel.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None
        })
        return _obj
