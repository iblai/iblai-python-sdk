...
class AWSTenantLaunchRequest(BaseModel):
    """
    ...
    aws_transaction_id: StrictStr = Field(description="AWS Marketplace Customer Id and Product Code Identifier")
    __properties: ClassVar[List[str]] = ["username", "email", "firstname", "lastname", "password", "name", "key", "ignore_user_exists", "is_advertising", "aws_transaction_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aws_transaction_id": obj.get("aws_transaction_id")
        })
        return _obj
