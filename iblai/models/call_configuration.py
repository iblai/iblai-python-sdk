...
class CallConfiguration(BaseModel):
    ...
    language: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(default=None, description="Language code for TTS, STT, and LLM (e.g., 'en', 'en-US', 'es', 'fr'). Defaults to 'en' (English).")
    ...
    screensharing_system_prompt: Optional[StrictStr] = Field(default=None, description="System prompt to use for screensharing guidance. Defaults to VIDEO_GUIDANCE_PROMPT from constants.")
    screensharing_proactive_prompt: Optional[StrictStr] = Field(default=None, description="Proactive prompt used during screensharing calls to guide the conversation.")
    platform_key: StrictStr
    __properties: ClassVar[List[str]] = ["id", "mentor", "mode", "tts_provider", "stt_provider", "llm_provider", "language", "use_function_calling_for_rag", "google_voice", "openai_voice", "openai_voice_id", "google_voice_id", "enable_video", "screensharing_system_prompt", "screensharing_proactive_prompt", "platform_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "screensharing_system_prompt": obj.get("screensharing_system_prompt"),
            "screensharing_proactive_prompt": obj.get("screensharing_proactive_prompt"),
