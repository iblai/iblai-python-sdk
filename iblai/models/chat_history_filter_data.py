...
class ChatHistoryFilterData(BaseModel):
    """
    ChatHistoryFilterData
    """ # noqa: E501
    topics: List[TopicModel]
    date_ranges: Optional[List[DateRange]] = None
    sentiment: Optional[List[StrictStr]] = None
    users: List[ChatHistoryFilterUser]
    __properties: ClassVar[List[str]] = ["topics", "date_ranges", "sentiment", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date_ranges": [DateRange.from_dict(_item) for _item in obj["date_ranges"]] if obj.get("date_ranges") is not None else None,
            "sentiment": obj.get("sentiment"),
            "users": [ChatHistoryFilterUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
