...
class ComparisonInfo(BaseModel):
    ...
    previous_period_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost value for comparison period")
    ...
    recent_period_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cost value for current period")
