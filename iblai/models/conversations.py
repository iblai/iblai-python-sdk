...
class Conversations(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "messages", "topics", "sentiment", "mentor", "student", "model", "rating", "inserted_at", "has_document", "memory_tracked", "llm_name", "llm_provider", "metadata", "platform"]
