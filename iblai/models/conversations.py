...
class Conversations(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "messages", "topics", "sentiment", "mentor", "student", "email", "model", "rating", "platform", "lti_email", "lti_username", "inserted_at", "has_document", "memory_tracked", "llm_name", "llm_provider", "metadata", "is_conversation", "tools"]
