...
class Conversations(BaseModel):
    ...
    is_authenticated: Optional[StrictBool] = Field(default=None, description="False if session was created by an anonymous user")
    ...
    title: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="AI-generated title summarizing the conversation")
    is_conversation: Optional[StrictBool] = Field(default=None, description="True if the session has both user and AI messages")
    message_count_human: Optional[StrictInt] = Field(default=None, description="Count of human messages in this session")
    message_count_ai: Optional[StrictInt] = Field(default=None, description="Count of AI messages in this session")
    tools: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "messages", "topics", "sentiment", "mentor", "student", "email", "model", "rating", "platform", "lti_email", "lti_username", "inserted_at", "has_document", "memory_tracked", "enable_artifacts", "is_shared", "is_authenticated", "llm_name", "llm_provider", "metadata", "title", "is_conversation", "message_count_human", "message_count_ai", "tools"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message_count_human": obj.get("message_count_human"),
            "message_count_ai": obj.get("message_count_ai"),
            "tools": obj.get("tools")
        })
        return _obj
