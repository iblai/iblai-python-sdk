...
class ConversationsChart(BaseModel):
    """
    ConversationsChart
    """ # noqa: E501
    metric: StrictStr
    points: List[ConversationChartPoint]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "points": [ConversationChartPoint.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None
        })
        return _obj
