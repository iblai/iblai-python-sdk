...
class CourseCompletionSummaryOvertime(BaseModel):
    """
    CourseCompletionSummaryOvertime
    """ # noqa: E501
    data: CourseCompletionSummaryDataOvertime
    meta: OvertimeMeta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CourseCompletionSummaryDataOvertime.from_dict(obj["data"]) if obj.get("data") is not None else None,
