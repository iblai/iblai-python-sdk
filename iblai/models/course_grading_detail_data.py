...
class CourseGradingDetailData(BaseModel):
    """
    CourseGradingDetailData
    """ # noqa: E501
    display_name: StrictStr = Field(description="Chapter name")
    id: StrictStr = Field(description="Chapter Id")
    subsections: Optional[List[CourseGradeDetailSubSection]] = None
    __properties: ClassVar[List[str]] = ["display_name", "id", "subsections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "subsections": [CourseGradeDetailSubSection.from_dict(_item) for _item in obj["subsections"]] if obj.get("subsections") is not None else None
        })
        return _obj
