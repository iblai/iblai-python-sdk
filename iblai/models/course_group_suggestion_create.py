...
class CourseGroupSuggestionCreate(BaseModel):
    """
    ...
    group_id: StrictInt = Field(description="The group to suggest the course to")
    ...
    __properties: ClassVar[List[str]] = ["platform_key", "course_id", "group_id", "accepted", "visible", "metadata", "suggested_by", "direct", "department_mode"]
