...
class CourseInvitationDetail(BaseModel):
    """
    ...
    course_id: StrictStr = Field(description="The course ID associated with the invitation")
    __properties: ClassVar[List[str]] = ["id", "user_id", "username", "email", "created", "started", "expired", "source", "redirect_to", "active", "metadata", "course_id"]
