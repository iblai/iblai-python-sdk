...
class CourseInvitationRedemption(BaseModel):
    """
    Request serializer for CourseInvitationRedemptionView POST endpoint
    """ # noqa: E501
    course_id: StrictStr = Field(description="The course ID for the invitation")
    ...
    __properties: ClassVar[List[str]] = ["course_id", "source", "email", "username", "metadata"]
