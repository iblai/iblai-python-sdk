...
class CourseLicenseAssignmentDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "username", "email", "active", "fulfilled", "redirect_to", "metadata", "license_id", "license_name", "course_id"]
