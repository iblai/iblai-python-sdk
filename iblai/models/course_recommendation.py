...
class CourseRecommendation(BaseModel):
    ...
    edx_data: Optional[Dict[str, Any]] = Field(default=None, description="Full edx_data from CourseInfo model (includes all edX metadata)")
    __properties: ClassVar[List[str]] = ["course_id", "course_title", "reason", "domain", "difficulty_level", "estimated_hours", "confidence_score", "platform_key", "description", "short_description", "edx_data"]
