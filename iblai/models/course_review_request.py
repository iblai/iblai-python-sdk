...
class CourseReviewRequest(BaseModel):
    ...
    """ # noqa: E501
    course_id: StrictStr = Field(description="The course ID to review")
    ...
    __properties: ClassVar[List[str]] = ["course_id", "username", "user_id", "rating", "title", "content", "visible", "metadata"]
