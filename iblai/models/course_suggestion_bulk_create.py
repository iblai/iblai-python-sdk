...
class CourseSuggestionBulkCreate(BaseModel):
    """
    ...
    suggestion_data: List[Dict[str, Any]] = Field(description="List of suggestion data objects, each containing course_id, user_id, etc.")
    department_mode: Optional[StrictBool] = Field(default=False, description="Flag to ensure department admins can call the API")
    __properties: ClassVar[List[str]] = ["platform_key", "suggestion_data", "department_mode"]
