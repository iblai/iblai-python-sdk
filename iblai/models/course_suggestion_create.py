...
class CourseSuggestionCreate(BaseModel):
    """
    ...
    course_id: StrictStr = Field(description="The course ID to suggest")
    user_id: StrictStr = Field(description="The user to suggest the course to")
    username: Optional[StrictStr] = Field(default=None, description="The username of the user to suggest the course to")
    email: Optional[StrictStr] = Field(default=None, description="The email of the user to suggest the course to")
    ...
    suggested_by: Optional[StrictStr] = Field(default=None, description="The user who suggested the course")
    ...
    __properties: ClassVar[List[str]] = ["platform_key", "course_id", "user_id", "username", "email", "accepted", "visible", "metadata", "suggested_by", "direct", "department_mode"]
