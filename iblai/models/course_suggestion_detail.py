...
class CourseSuggestionDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "username", "name", "platform_key", "accepted", "visible", "created", "modified", "metadata", "course_id", "course_name"]
