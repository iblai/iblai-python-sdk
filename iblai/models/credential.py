...
class Credential(BaseModel):
    ...
    programs: List[Dict[str, StrictStr]]
    ...
    __properties: ClassVar[List[str]] = ["entityId", "name", "name_override", "description", "criteriaUrl", "criteriaNarrative", "createdAt", "iconImage", "backgroundImage", "thumbnailImage", "catalog_items", "courses", "programs", "issuerDetails", "html_template", "css_template", "metadata", "credentialType", "expires", "tags", "signatories"]
