...
class DocumentSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    results: List[Document] = Field(description="List of documents matching the search criteria")
    count: StrictInt = Field(description="Total number of documents matching the search criteria")
    ...
    facets: Dict[str, DocumentFacet] = Field(description="Facet information for filtering")
