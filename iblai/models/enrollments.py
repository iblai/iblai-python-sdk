...
class Enrollments(BaseModel):
    ...
    Enrollments
    """ # noqa: E501
    data: Optional[List[EnrollmentsData]] = None
    pagination: Pagination
    meta: Optional[OvertimeMeta] = None
    __properties: ClassVar[List[str]] = ["data", "pagination", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EnrollmentsData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
