...
class EnrollmentsPerUserData(BaseModel):
    """
    ...
    timestamp: StrictStr = Field(description="Course start date")
    __properties: ClassVar[List[str]] = ["username", "full_name", "email", "timestamp"]
