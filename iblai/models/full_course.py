...
class FullCourse(BaseModel):
    ...
    run: Annotated[str, Field(strict=True, max_length=50)]
    number: Annotated[str, Field(strict=True, max_length=50)]
    description: Optional[StrictStr] = None
    xblock_id: Annotated[str, Field(strict=True, max_length=200)]
    task: Optional[StrictInt] = None
    created_at: datetime
    updated_at: datetime
    sections: List[SectionWithChildren]
    __properties: ClassVar[List[str]] = ["id", "name", "run", "number", "description", "xblock_id", "task", "created_at", "updated_at", "sections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sections": [SectionWithChildren.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
