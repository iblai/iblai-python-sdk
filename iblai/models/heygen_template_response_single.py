...
class HeygenTemplateResponseSingle(BaseModel):
    """
    HeygenTemplateResponseSingle
    """ # noqa: E501
    template_id: Optional[StrictStr]
    preview_image_url: Optional[StrictStr]
    name: StrictStr
    provider: StrictStr
    __properties: ClassVar[List[str]] = ["template_id", "preview_image_url", "name", "provider"]
