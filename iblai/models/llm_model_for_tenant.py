...
class LLMModelForTenant(BaseModel):
    """
    LLMModelForTenant
    """ # noqa: E501
    id: StrictInt
    llm_provider: Annotated[str, Field(strict=True, max_length=255)]
    llm_name: Annotated[str, Field(strict=True, max_length=255)]
    tenant: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "llm_provider", "llm_name", "tenant"]
