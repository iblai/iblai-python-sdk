...
class LLMModelRegistryMinimal(BaseModel):
    """
    Minimal serializer for LLMModelRegistry in fallback configs.
    """ # noqa: E501
    id: StrictInt
    llm_name: StrictStr = Field(description="Model identifier (e.g., 'gpt-4o', 'gemini-2.5-pro')")
    display_name: StrictStr = Field(description="Human-readable model name")
    provider_name: StrictStr
    __properties: ClassVar[List[str]] = ["id", "llm_name", "display_name", "provider_name"]
