...
class MarkAllReadRequest(BaseModel):
    ...
    """ # noqa: E501
    notification_ids: Optional[List[StrictStr]] = Field(default=None, description="Optional list of notification IDs to mark as read. If not provided, all unread notifications will be marked as read.")
