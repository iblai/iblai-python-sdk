...
class MathStudent(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    student: Annotated[int, Field(le=2147483647, strict=True, ge=0)] = Field(description="edX user ID")
    level: StrictInt
    points: StrictInt
    correct_questions_for_level: StrictInt = Field(description="Number of correctly answered questions at the student's current level")
    no_incorrect_questions_for_level: StrictInt = Field(description="Number of incorrectly answered questions at the student's current level")
    created_at: datetime
    updated_at: datetime
    acquired_skills: StrictStr
