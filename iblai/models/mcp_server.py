...
class MCPServer(BaseModel):
    ...
    headers: Optional[Any] = Field(default=None, description="Headers to send to the MCP server. Useful for authentication,")
    platform_key: StrictStr
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "platform", "name", "url", "transport", "headers", "platform_key", "created_at", "updated_at"]
