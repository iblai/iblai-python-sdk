...
class MCPServer(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "platform", "name", "description", "url", "image", "transport", "credentials", "extra_headers", "platform_key", "is_featured", "auth_type", "oauth_service", "oauth_service_data", "is_enabled", "created_at", "updated_at"]
