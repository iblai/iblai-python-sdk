...
class MemoryComponentMemoryDetail(BaseModel):
    """
    MemoryComponentMemoryDetail
    """ # noqa: E501
    data: List[MemoryComponentData]
    catalog_item: StrictStr
    mentor_unique_id: StrictStr
    student: StrictStr
    inserted_at: StrictStr
    __properties: ClassVar[List[str]] = ["data", "catalog_item", "mentor_unique_id", "student", "inserted_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MemoryComponentData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
