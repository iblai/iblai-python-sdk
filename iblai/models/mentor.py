...
class Mentor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "unique_id", "flow", "slug", "platform", "allow_anonymous", "metadata", "enable_moderation", "is_proactive", "proactive_prompt", "moderation_system_prompt", "moderation_response", "proactive_message", "created_by", "created_at", "updated_at"]
