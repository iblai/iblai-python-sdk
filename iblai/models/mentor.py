...
class Mentor(BaseModel):
    ...
    enable_offline_mode: Optional[StrictBool] = Field(default=None, description="Allow this mentor to be used offline with local LLMs")
    metadata: Optional[Any] = None
    enable_moderation: Optional[StrictBool] = None
    enable_multi_query_rag: Optional[StrictBool] = None
    enable_prompt_caching: Optional[StrictBool] = Field(default=None, description="Enable prompt caching for Anthropic models to reduce latency and cost. This disabled RAG and other dynamic parts of system prompt such as memory, current datetime, etc. Use with caution")
    ...
    save_flagged_prompts: Optional[StrictBool] = None
    ...
    is_featured: Optional[StrictBool] = Field(default=None, description="Whether the mentor is featured or not.")
    ...
    study_mode_prompt: Optional[StrictStr] = Field(default=None, description="Prompt to be used to guide the user through their studies when study mode tool is enabled.")
    disclaimer: Optional[StrictStr] = Field(default=None, description="Disclaimer to be shown to the user when the mentor is used.")
    enable_disclaimer: Optional[StrictBool] = None
    show_attachment: Optional[StrictBool] = Field(default=None, description="Show attachments on mentor.")
    show_voice_call: Optional[StrictBool] = Field(default=None, description="Show voice call button on mentor.")
    show_voice_record: Optional[StrictBool] = Field(default=None, description="Show voice recording button on mentor.")
    show_rag_images: Optional[StrictBool] = Field(default=None, description="Show RAG images in mentor response.")
    starter_prompts: Optional[StarterPromptsB04Enum] = Field(default=None, description="Type of starter prompts to show: guided_prompt or suggested_prompt.  * `guided_prompt` - Guided Prompt * `suggested_prompt` - Suggested Prompt")
    embed_is_context_aware: Optional[StrictBool] = Field(default=None, description="Allow embedded mentor to read content on the embedded web page.")
    embed_open_by_default: Optional[StrictBool] = Field(default=None, description="Open mentor embed iframe by default.")
    embed_show_attachment: Optional[StrictBool] = Field(default=None, description="Show attachments on embedded mentor.")
    embed_show_voice_call: Optional[StrictBool] = Field(default=None, description="Show voice call button on embedded mentor.")
    embed_show_voice_record: Optional[StrictBool] = Field(default=None, description="Show voice recording button on embedded mentor.")
    show_explore_mentors: Optional[StrictBool] = Field(default=None, description="Show explore mentors option.")
    embed_icon_selection_data: Optional[Any] = Field(default=None, description="Stores embedded icon selection data for the mentor widget.")
    placeholder_prompt: Optional[StrictStr] = Field(default=None, description="Placeholder to be shown in the input text area when the mentor is used.")
    ...
    call_configuration: Optional[CallConfiguration] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "unique_id", "flow", "slug", "platform", "allow_anonymous", "enable_offline_mode", "metadata", "enable_moderation", "enable_multi_query_rag", "enable_prompt_caching", "enable_post_processing_system", "enable_openai_assistant", "enable_total_grounding", "enable_suggested_prompts", "enable_guided_prompts", "save_flagged_prompts", "guided_prompt_instructions", "google_voice", "openai_voice", "categories", "types", "is_featured", "subjects", "proactive_prompt", "study_mode_prompt", "disclaimer", "enable_disclaimer", "show_attachment", "show_voice_call", "show_voice_record", "show_rag_images", "starter_prompts", "embed_is_context_aware", "embed_open_by_default", "embed_show_attachment", "embed_show_voice_call", "embed_show_voice_record", "show_explore_mentors", "embed_icon_selection_data", "placeholder_prompt", "moderation_system_prompt", "post_processing_prompt", "moderation_response", "safety_system_prompt", "safety_response", "enable_safety_system", "proactive_response", "greeting_method", "call_configuration", "mcp_servers", "last_accessed_by", "recently_accessed_at", "created_by", "created_at", "updated_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if embed_icon_selection_data (nullable) is None
        # and model_fields_set contains the field
        if self.embed_icon_selection_data is None and "embed_icon_selection_data" in self.model_fields_set:
            _dict['embed_icon_selection_data'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enable_offline_mode": obj.get("enable_offline_mode"),
            ...
            "save_flagged_prompts": obj.get("save_flagged_prompts"),
            ...
            "study_mode_prompt": obj.get("study_mode_prompt"),
            "disclaimer": obj.get("disclaimer"),
            "enable_disclaimer": obj.get("enable_disclaimer"),
            "show_attachment": obj.get("show_attachment"),
            "show_voice_call": obj.get("show_voice_call"),
            "show_voice_record": obj.get("show_voice_record"),
            "show_rag_images": obj.get("show_rag_images"),
            ...
            "show_explore_mentors": obj.get("show_explore_mentors"),
            "embed_icon_selection_data": obj.get("embed_icon_selection_data"),
