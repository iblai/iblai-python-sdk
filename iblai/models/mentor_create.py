...
class MentorCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "unique_id", "flow", "slug", "platform", "allow_anonymous", "metadata", "enable_moderation", "enable_multi_query_rag", "enable_post_processing_system", "enable_openai_assistant", "enable_total_grounding", "enable_suggested_prompts", "enable_guided_prompts", "google_voice", "openai_voice", "guided_prompt_instructions", "categories", "types", "subjects", "proactive_prompt", "disclaimer", "placeholder_prompt", "moderation_system_prompt", "post_processing_prompt", "moderation_response", "safety_system_prompt", "safety_response", "disable_chathistory", "enable_safety_system", "proactive_response", "mcp_servers", "greeting_method", "last_accessed_by", "recently_accessed_at", "created_by", "created_at", "updated_at"]
