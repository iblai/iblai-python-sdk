...
class MentorFromTemplateWithSettingRequest(BaseModel):
    ...
    enable_disclaimer: Optional[StrictBool] = True
    show_attachment: Optional[StrictBool] = True
    show_voice_call: Optional[StrictBool] = True
    show_voice_record: Optional[StrictBool] = True
    show_rag_images: Optional[StrictBool] = False
    starter_prompts: Optional[StarterPrompts8c6Enum] = None
    embed_is_context_aware: Optional[StrictBool] = False
    embed_open_by_default: Optional[StrictBool] = False
    embed_show_attachment: Optional[StrictBool] = True
    embed_show_voice_call: Optional[StrictBool] = True
    embed_show_voice_record: Optional[StrictBool] = True
    show_explore_mentors: Optional[StrictBool] = True
    ...
    enable_multi_query_rag: Optional[StrictBool] = False
    enable_prompt_caching: Optional[StrictBool] = False
    ...
    save_flagged_prompts: Optional[StrictBool] = True
    ...
    __properties: ClassVar[List[str]] = ["template_name", "display_name", "description", "profile_image", "initial_message", "suggested_message", "new_mentor_name", "theme", "user_message_color", "mentor_bubble_color", "align_mentor_bubble", "system_prompt", "llm_provider", "llm_name", "mentor_visibility", "enable_image_generation", "enable_web_browsing", "enable_code_interpreter", "metadata", "custom_css", "custom_javascript", "uploaded_profile_image", "embed_custom_image", "proactive_response", "greeting_method", "forkable", "forkable_with_training_data", "categories", "types", "subjects", "tool_slugs", "llm_temperature", "seo_tags", "marketing_conversations", "proactive_prompt", "study_mode_prompt", "disclaimer", "enable_disclaimer", "show_attachment", "show_voice_call", "show_voice_record", "show_rag_images", "starter_prompts", "embed_is_context_aware", "embed_open_by_default", "embed_show_attachment", "embed_show_voice_call", "embed_show_voice_record", "show_explore_mentors", "embed_icon_selection_data", "placeholder_prompt", "moderation_system_prompt", "post_processing_prompt", "moderation_response", "enable_moderation", "enable_multi_query_rag", "enable_prompt_caching", "enable_post_processing_system", "enable_openai_assistant", "enable_total_grounding", "google_voice", "openai_voice", "enable_suggested_prompts", "enable_guided_prompts", "save_flagged_prompts", "mcp_servers", "guided_prompt_instructions", "is_featured"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if save_flagged_prompts (nullable) is None
        # and model_fields_set contains the field
        if self.save_flagged_prompts is None and "save_flagged_prompts" in self.model_fields_set:
            _dict['save_flagged_prompts'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enable_disclaimer": obj.get("enable_disclaimer") if obj.get("enable_disclaimer") is not None else True,
            "show_attachment": obj.get("show_attachment") if obj.get("show_attachment") is not None else True,
            "show_voice_call": obj.get("show_voice_call") if obj.get("show_voice_call") is not None else True,
            "show_voice_record": obj.get("show_voice_record") if obj.get("show_voice_record") is not None else True,
            "show_rag_images": obj.get("show_rag_images") if obj.get("show_rag_images") is not None else False,
            "starter_prompts": obj.get("starter_prompts"),
            "embed_is_context_aware": obj.get("embed_is_context_aware") if obj.get("embed_is_context_aware") is not None else False,
            "embed_open_by_default": obj.get("embed_open_by_default") if obj.get("embed_open_by_default") is not None else False,
            "embed_show_attachment": obj.get("embed_show_attachment") if obj.get("embed_show_attachment") is not None else True,
            "embed_show_voice_call": obj.get("embed_show_voice_call") if obj.get("embed_show_voice_call") is not None else True,
            "embed_show_voice_record": obj.get("embed_show_voice_record") if obj.get("embed_show_voice_record") is not None else True,
            "show_explore_mentors": obj.get("show_explore_mentors") if obj.get("show_explore_mentors") is not None else True,
            ...
            "enable_multi_query_rag": obj.get("enable_multi_query_rag") if obj.get("enable_multi_query_rag") is not None else False,
            "enable_prompt_caching": obj.get("enable_prompt_caching") if obj.get("enable_prompt_caching") is not None else False,
            ...
            "save_flagged_prompts": obj.get("save_flagged_prompts") if obj.get("save_flagged_prompts") is not None else True,
