...
class MentorPolicy(BaseModel):
    ...
    usernames_to_add: Optional[List[StrictStr]] = Field(default=None, description="List of usernames to grant access to this mentor")
    emails_to_add: Optional[List[StrictStr]] = Field(default=None, description="List of user emails to grant access to this mentor")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "platform_key", "mentor_id", "role", "resources", "users", "groups", "groups_to_add", "groups_to_remove", "users_to_add", "usernames_to_add", "emails_to_add", "users_to_remove"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emails_to_add": obj.get("emails_to_add"),
