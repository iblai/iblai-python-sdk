...
class MentorScenario(BaseModel):
    """
    MentorScenario
    """ # noqa: E501
    display: Optional[StrictStr] = None
    name: StrictStr
    prompts: List[MentorScenarioPrompt]
    __properties: ClassVar[List[str]] = ["display", "name", "prompts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "prompts": [MentorScenarioPrompt.from_dict(_item) for _item in obj["prompts"]] if obj.get("prompts") is not None else None
        })
        return _obj
