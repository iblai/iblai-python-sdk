...
class MentorSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "display_name", "profile_image", "initial_message", "suggested_message", "theme", "user_message_color", "mentor_bubble_color", "align_mentor_bubble", "mentor", "mentor_slug", "mentor_unique_id", "metadata", "mentor_visibility", "enable_image_generation", "enable_web_browsing", "enable_code_interpreter", "custom_css", "allow_anonymous", "mentor_description", "suggested_prompts", "proactive_response", "greeting_method", "mentor_tools", "can_use_tools", "llm_name", "proactive_prompt", "disclaimer", "placeholder_prompt", "enable_email_chat", "enable_spaced_repetition", "enable_instruction_mode", "enable_socratic_mode", "is_guided_mentor", "enable_guided_prompts", "enable_moderation", "enable_multi_query_rag", "enable_post_processing_system", "enable_safety_system", "forkable", "forkable_with_training_data", "mentor_name", "categories", "types", "subjects", "recently_accessed_at", "created_by", "created_at", "updated_at", "platform_key", "system_prompt", "llm_provider", "llm_temperature", "safety_system_prompt", "safety_response", "moderation_system_prompt", "post_processing_prompt", "moderation_response", "mcp_servers", "department", "disable_chathistory", "call_configuration", "guided_prompt_instructions", "seo_tags", "marketing_conversations", "template_mentor", "google_voice", "openai_voice", "enable_openai_assistant", "enable_total_grounding", "enable_suggested_prompts", "is_deleted"]
