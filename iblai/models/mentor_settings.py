...
class MentorSettings(BaseModel):
    ...
    enable_custom_javascript: StrictBool
    allow_anonymous: StrictBool
    enable_offline_mode: StrictBool
    ...
    study_mode_prompt: StrictStr
    disclaimer: StrictStr
    enable_disclaimer: StrictBool
    show_attachment: StrictBool
    show_voice_call: StrictBool
    show_voice_record: StrictBool
    show_rag_images: StrictBool
    starter_prompts: StrictStr
    ...
    show_explore_mentors: StrictBool
    embed_icon_selection_data: Optional[Any]
    ...
    save_flagged_prompts: StrictBool
    enable_moderation: StrictBool
    enable_multi_query_rag: StrictBool
    enable_prompt_caching: StrictBool
