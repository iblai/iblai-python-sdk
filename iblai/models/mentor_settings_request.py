...
class MentorSettingsRequest(BaseModel):
    ...
    is_lti_accessible: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["mentor_name", "template_name", "display_name", "profile_image", "initial_message", "suggested_message", "theme", "user_message_color", "mentor_bubble_color", "align_mentor_bubble", "system_prompt", "llm_provider", "llm_name", "featured", "disable_chathistory", "metadata", "custom_css", "custom_javascript", "department_id", "mentor_visibility", "enable_image_generation", "enable_web_browsing", "enable_code_interpreter", "is_lti_accessible", "allow_anonymous", "enable_offline_mode", "forkable", "forkable_with_training_data", "mentor_description", "uploaded_profile_image", "embed_custom_image", "proactive_response", "greeting_method", "can_use_tools", "tool_slugs", "llm_temperature", "proactive_prompt", "study_mode_prompt", "disclaimer", "placeholder_prompt", "moderation_system_prompt", "post_processing_prompt", "moderation_response", "enable_moderation", "enable_multi_query_rag", "enable_prompt_caching", "enable_post_processing_system", "enable_openai_assistant", "enable_total_grounding", "enable_suggested_prompts", "enable_guided_prompts", "save_flagged_prompts", "mcp_servers", "show_attachment", "show_voice_call", "show_voice_record", "show_rag_images", "starter_prompts", "embed_is_context_aware", "embed_open_by_default", "embed_show_attachment", "embed_show_voice_call", "embed_show_voice_record", "show_explore_mentors", "embed_icon_selection_data", "google_voice", "openai_voice", "guided_prompt_instructions", "safety_system_prompt", "safety_response", "enable_safety_system", "enable_memory_component", "enable_spaced_repetition", "enable_instruction_mode", "enable_socratic_mode", "is_guided_mentor", "is_featured", "enable_email_chat", "categories", "types", "subjects"]
