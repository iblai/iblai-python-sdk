...
class MessageViewRequest(BaseModel):
    """
    MessageViewRequest
    """ # noqa: E501
    title: Optional[StrictStr] = None
    tools: Optional[List[StrictStr]] = Field(default=None, description="List of tools slugs to use")
    enable_artifacts: Optional[StrictBool] = None
    is_shared: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["title", "tools", "enable_artifacts", "is_shared"]
