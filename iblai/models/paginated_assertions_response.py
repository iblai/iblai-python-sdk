...
class PaginatedAssertionsResponse(BaseModel):
    """
    ...
    max_page_size: StrictInt
    data: List[Assertion]
    __properties: ClassVar[List[str]] = ["next", "previous", "count", "num_pages", "page_number", "max_page_size", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_page_size": obj.get("max_page_size"),
            "data": [Assertion.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
