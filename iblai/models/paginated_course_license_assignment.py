...
class PaginatedCourseLicenseAssignment(BaseModel):
    """
    ...
    results: List[CourseLicenseAssignmentDetail] = Field(description="List of course license assignments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [CourseLicenseAssignmentDetail.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
