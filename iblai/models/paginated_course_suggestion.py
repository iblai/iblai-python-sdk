...
class PaginatedCourseSuggestion(BaseModel):
    """
    ...
    results: List[CourseSuggestionDetail] = Field(description="List of course suggestions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [CourseSuggestionDetail.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
