...
class PaginatedPlatformInvitation(BaseModel):
    """
    ...
    results: List[PlatformInvitationDetail] = Field(description="List of platform invitations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [PlatformInvitationDetail.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
