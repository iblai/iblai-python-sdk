...
class PaginatedPlatformLicense(BaseModel):
    """
    ...
    results: List[PlatformLicenseDetail] = Field(description="List of platform licenses")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [PlatformLicenseDetail.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
