...
class PatchedArtifact(BaseModel):
    ...
    content: Optional[StrictStr] = Field(default=None, description="Content of the artifact")
    ...
    current_version_number: Optional[StrictInt] = Field(default=None, description="Version number of the current version")
    version_count: Optional[StrictInt] = Field(default=None, description="Total number of versions for this artifact")
