...
class PatchedMathQuestion(BaseModel):
    """
    PatchedMathQuestion
    """ # noqa: E501
    id: Optional[StrictInt] = None
    topic: Optional[Topic] = None
    sub_topic: Optional[SubTopic] = None
    skills_assessed: Optional[List[Skill]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "topic", "sub_topic", "skills_assessed", "content", "difficulty", "cognitive_skills", "grade", "expected_time_to_solve", "related_concepts", "hints_provided", "learning_outcomes", "prerequisites", "recommended_grade_level", "image", "created_at", "updated_at", "platform"]
