...
class PatchedMentorCreate(BaseModel):
    ...
    subjects: Optional[List[StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "unique_id", "flow", "slug", "platform", "allow_anonymous", "enable_offline_mode", "metadata", "enable_moderation", "enable_multi_query_rag", "enable_prompt_caching", "enable_post_processing_system", "enable_openai_assistant", "enable_total_grounding", "enable_suggested_prompts", "enable_guided_prompts", "save_flagged_prompts", "google_voice", "openai_voice", "guided_prompt_instructions", "categories", "types", "subjects", "proactive_prompt", "study_mode_prompt", "disclaimer", "enable_disclaimer", "show_attachment", "show_voice_call", "show_voice_record", "show_rag_images", "starter_prompts", "embed_is_context_aware", "embed_open_by_default", "embed_show_attachment", "embed_show_voice_call", "embed_show_voice_record", "show_explore_mentors", "embed_icon_selection_data", "placeholder_prompt", "moderation_system_prompt", "post_processing_prompt", "moderation_response", "safety_system_prompt", "safety_response", "disable_chathistory", "enable_safety_system", "proactive_response", "mcp_servers", "greeting_method", "last_accessed_by", "recently_accessed_at", "created_by", "created_at", "updated_at"]
