...
class PatchedPeriodicAgentCreate(BaseModel):
    """
    ...
    task: Optional[PeriodicTask] = None
    created_at: Optional[datetime] = None
    modified_at: Optional[datetime] = None
    enabled: Optional[StrictBool] = None
    one_off: Optional[StrictStr] = None
    ...
    parent_mentor_id: Optional[Annotated[int, Field(le=9223372036854775807, strict=True, ge=-9223372036854775808)]] = None
    ...
    previous_agent_output: Optional[StrictStr] = Field(default=None, description="This will be fed into the run of this agent as part of its input prompt.")
    __properties: ClassVar[List[str]] = ["id", "mentor", "title", "username", "description", "prompt", "task", "created_at", "modified_at", "enabled", "one_off", "platform_key", "pathway", "parent_session_id", "parent_mentor_id", "previous_agent", "previous_agent_status", "previous_agent_output"]
