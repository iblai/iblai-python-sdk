...
class PatchedPlatformPublicMetadata(BaseModel):
    """
    PatchedPlatformPublicMetadata
    """ # noqa: E501
    platform_key: Optional[StrictStr] = None
    platform_name: Optional[StrictStr] = None
    metadata: Optional[Any] = Field(default=None, description="The public metadata")
    __properties: ClassVar[List[str]] = ["platform_key", "platform_name", "metadata"]
