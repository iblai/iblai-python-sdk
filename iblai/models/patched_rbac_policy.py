...
class PatchedRbacPolicy(BaseModel):
    ...
    is_internal: Optional[StrictBool] = Field(default=None, description="When True, this policy is internal to the system and cannot be modified by tenants via API endpoints.")
