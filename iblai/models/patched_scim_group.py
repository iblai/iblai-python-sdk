...
class PatchedSCIMGroup(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="RBAC group unique ID (must match existing RBAC group)")
    display_name: Optional[StrictStr] = Field(default=None, description="RBAC group display name", alias="displayName")
