...
class PatchedUnit(BaseModel):
    ...
    status: Optional[Status6eeEnum] = None
    type: Optional[TypeC42Enum] = None
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "subsection", "display_name", "status", "type", "created_at", "updated_at"]
