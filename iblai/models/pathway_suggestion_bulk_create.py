...
class PathwaySuggestionBulkCreate(BaseModel):
    """
    ...
    suggestion_data: List[Dict[str, Any]] = Field(description="List of suggestion data objects, each containing pathway_id, user_id, etc.")
