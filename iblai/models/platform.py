...
class Platform(BaseModel):
    ...
    is_advertising: Optional[StrictBool] = Field(default=None, description="Advertising mode allows a platform to set custom usd balance to allocate for its members")
    is_enterprise: StrictStr
    show_paywall: StrictBool = Field(description="If True, billing status/credit checks are enforced for this platform's users")
    __properties: ClassVar[List[str]] = ["key", "name", "org", "lms_url", "cms_url", "portal_url", "is_advertising", "is_enterprise", "show_paywall"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_advertising": obj.get("is_advertising"),
            "is_enterprise": obj.get("is_enterprise"),
            "show_paywall": obj.get("show_paywall")
        })
        return _obj
