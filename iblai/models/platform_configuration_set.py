...
class PlatformConfigurationSet(BaseModel):
    """
    Serializer for setting platform configurations
    """ # noqa: E501
    platform_key: StrictStr = Field(description="Platform key to set configurations for")
    configurations: List[ConfigurationItem] = Field(description="List of configurations to set")
    __properties: ClassVar[List[str]] = ["platform_key", "configurations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configurations": [ConfigurationItem.from_dict(_item) for _item in obj["configurations"]] if obj.get("configurations") is not None else None
        })
        return _obj
