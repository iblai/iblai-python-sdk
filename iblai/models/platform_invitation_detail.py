...
class PlatformInvitationDetail(BaseModel):
    """
    ...
    user_id: Optional[StrictInt] = Field(default=None, description="The ID of the user associated with the invitation")
    ...
    platform_key: StrictStr = Field(description="The platform key associated with the invitation")
    __properties: ClassVar[List[str]] = ["id", "user_id", "username", "email", "created", "started", "expired", "source", "redirect_to", "active", "metadata", "platform_key"]
