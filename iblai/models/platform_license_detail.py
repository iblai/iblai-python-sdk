...
class PlatformLicenseDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "started", "expired", "name", "count", "active", "metadata", "source", "external_id", "platform_key"]
