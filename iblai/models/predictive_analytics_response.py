...
class PredictiveAnalyticsResponse(BaseModel):
    ...
    """ # noqa: E501
    predictions: List[ResponseDataVariable]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predictions": [ResponseDataVariable.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
