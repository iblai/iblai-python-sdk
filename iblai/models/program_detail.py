...
class ProgramDetail(BaseModel):
    ...
    completion: Optional[ProgramCompletion] = None
    __properties: ClassVar[List[str]] = ["program_id", "name", "platform", "enrollment", "completion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "completion": ProgramCompletion.from_dict(obj["completion"]) if obj.get("completion") is not None else None
        })
        return _obj
