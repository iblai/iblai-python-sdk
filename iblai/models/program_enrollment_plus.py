...
class ProgramEnrollmentPlus(BaseModel):
    """
    Includes metadata+
    """ # noqa: E501
    ...
    program_metadata: Optional[Dict[str, Any]] = Field(description="Return program's public metadata")
    __properties: ClassVar[List[str]] = ["user_id", "username", "program_id", "program_key", "platform_key", "org", "name", "slug", "created", "started", "ended", "expired", "active", "metadata", "program_metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if program_metadata (nullable) is None
        # and model_fields_set contains the field
        if self.program_metadata is None and "program_metadata" in self.model_fields_set:
            _dict['program_metadata'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "program_metadata": obj.get("program_metadata")
        })
        return _obj
