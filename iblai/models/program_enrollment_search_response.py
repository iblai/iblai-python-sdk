...
class ProgramEnrollmentSearchResponse(BaseModel):
    """
    Response serializer for ProgramEnrollmentSearchView GET endpoint.
    """ # noqa: E501
    results: List[ProgramEnrollmentPlus] = Field(description="List of program enrollments")
    count: StrictInt = Field(description="Total number of reviews")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ProgramEnrollmentPlus.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "count": obj.get("count"),
