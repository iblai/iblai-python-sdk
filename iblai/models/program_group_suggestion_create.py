...
class ProgramGroupSuggestionCreate(BaseModel):
    """
    ...
    group_id: StrictInt = Field(description="The group to suggest the program to")
    ...
    __properties: ClassVar[List[str]] = ["platform_key", "platform_org", "program_key", "group_id", "accepted", "visible", "metadata", "department_mode"]
