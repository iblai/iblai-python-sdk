...
class ProgramInvitationCreate(BaseModel):
    ...
    program_access_start_date: Optional[datetime] = Field(default=None, description="Program access start date (maps to enrollment_config['started'])")
    program_access_expiration_date: Optional[datetime] = Field(default=None, description="Program access expiration date (maps to enrollment_config['expired'])")
    __properties: ClassVar[List[str]] = ["program_key", "email", "username", "active", "source", "redirect_to", "created", "expired", "metadata", "enrollment_config", "program_access_start_date", "program_access_expiration_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if program_access_start_date (nullable) is None
        # and model_fields_set contains the field
        if self.program_access_start_date is None and "program_access_start_date" in self.model_fields_set:
            _dict['program_access_start_date'] = None

        # set to None if program_access_expiration_date (nullable) is None
        # and model_fields_set contains the field
        if self.program_access_expiration_date is None and "program_access_expiration_date" in self.model_fields_set:
            _dict['program_access_expiration_date'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "program_access_start_date": obj.get("program_access_start_date"),
            "program_access_expiration_date": obj.get("program_access_expiration_date")
        })
        return _obj
