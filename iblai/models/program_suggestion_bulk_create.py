...
class ProgramSuggestionBulkCreate(BaseModel):
    """
    Request serializer for ProgramSuggestionBulkManagementView POST endpoint
    """ # noqa: E501
    platform_key: StrictStr = Field(description="The platform for the suggestions")
    platform_org: Optional[StrictStr] = Field(default=None, description="The organization identifier for the platform")
    suggestion_data: List[Dict[str, Any]] = Field(description="List of suggestion data objects, each containing program_key, user_id, etc.")
    department_mode: Optional[StrictBool] = Field(default=False, description="Flag to ensure department admins can call the API")
    __properties: ClassVar[List[str]] = ["platform_key", "platform_org", "suggestion_data", "department_mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suggestion_data": obj.get("suggestion_data"),
