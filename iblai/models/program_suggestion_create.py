...
class ProgramSuggestionCreate(BaseModel):
    """
    ...
    program_key: StrictStr = Field(description="The program key to suggest")
    user_id: StrictStr = Field(description="The user to suggest the program to")
    username: Optional[StrictStr] = Field(default=None, description="The username of the user to suggest the program to")
    email: Optional[StrictStr] = Field(default=None, description="The email of the user to suggest the program to")
    suggested_by: Optional[StrictStr] = Field(default=None, description="The user who suggested the program")
    ...
    __properties: ClassVar[List[str]] = ["platform_key", "platform_org", "program_key", "user_id", "username", "email", "suggested_by", "direct", "department_mode", "accepted", "visible", "metadata"]
