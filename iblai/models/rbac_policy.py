...
class RbacPolicy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "role", "platform", "resources", "users", "groups", "role_id", "platform_key", "users_to_add", "users_to_remove", "groups_to_add", "groups_to_remove"]
