...
class ReportStatus(BaseModel):
    ...
    created_at: Optional[StrictStr] = Field(default=None, description="When the report was requested (ISO 8601)")
    __properties: ClassVar[List[str]] = ["report_id", "report_name", "state", "started_on", "owner", "expires", "url", "created_at"]
