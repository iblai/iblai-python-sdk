...
class ReportedSkillCreateUpdateRequest(BaseModel):
    """
    ...
    skills: List[Dict[str, Any]] = Field(description="List of skills (can be skill IDs or objects with name, platform_key, etc.)")
