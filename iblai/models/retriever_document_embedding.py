...
class RetrieverDocumentEmbedding(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "metadata", "document_name", "document_type", "training_status", "pathway", "url", "tokens", "platform_key", "is_trained", "access", "crawler_max_depth", "crawler_max_pages_limit", "crawler_max_concurrency", "crawler_match_patterns", "crawler_pattern_type", "last_trained_at"]
