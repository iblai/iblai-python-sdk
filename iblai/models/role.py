...
class Role(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    name: Optional[StrictStr] = Field(description="The display name of the role.")
    slug: Optional[StrictStr] = Field(description="An additional unique slug field.")
    platform_key: Optional[StrictStr] = None
    skills: List[Skill]
    data: Optional[Any] = Field(description="Metadata")
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "platform_key", "skills", "data"]
