...
class RoleCreateUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Role ID (for updates)")
    name: StrictStr = Field(description="Role name")
    slug: Optional[StrictStr] = Field(default=None, description="Role slug")
    platform_key: Optional[StrictStr] = Field(default=None, description="Platform key")
    data: Optional[Any] = Field(default=None, description="Additional role data")
