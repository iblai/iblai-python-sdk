...
class SectionWithChildren(BaseModel):
    """
    SectionWithChildren
    """ # noqa: E501
    id: StrictInt
    ...
    subsections: List[SubSectionWithChildren]
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "course", "display_name", "status", "subsections", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subsections": [SubSectionWithChildren.from_dict(_item) for _item in obj["subsections"]] if obj.get("subsections") is not None else None,
