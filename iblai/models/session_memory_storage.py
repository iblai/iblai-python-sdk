...
class SessionMemoryStorage(BaseModel):
    """
    SessionMemoryStorage
    """ # noqa: E501
    memory: MemoryComponentMemory
    updated_at: StrictStr
    session_id: StrictStr
    __properties: ClassVar[List[str]] = ["memory", "updated_at", "session_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "memory": MemoryComponentMemory.from_dict(obj["memory"]) if obj.get("memory") is not None else None,
