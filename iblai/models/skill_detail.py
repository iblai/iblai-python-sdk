...
class SkillDetail(BaseModel):
    ...
    courses: List[CourseSkill]
    related_skills: StrictInt
    __properties: ClassVar[List[str]] = ["name", "courses", "related_skills"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "courses": [CourseSkill.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
            "related_skills": obj.get("related_skills")
        })
        return _obj
