...
class SpacedRepetitionQuestionStats(BaseModel):
    """
    SpacedRepetitionQuestionStats
    """ # noqa: E501
    total_questions: StrictInt
    success_rate: Union[StrictFloat, StrictInt]
    reviewed_questions: StrictInt
    __properties: ClassVar[List[str]] = ["total_questions", "success_rate", "reviewed_questions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reviewed_questions": obj.get("reviewed_questions")
        })
        return _obj
