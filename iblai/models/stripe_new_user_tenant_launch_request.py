...
class StripeNewUserTenantLaunchRequest(BaseModel):
    """
    ...
    stripe_checkout_id_alt: StrictStr = Field(description="Stripe Checkout Id to launch the tenant")
    __properties: ClassVar[List[str]] = ["username", "email", "firstname", "lastname", "password", "name", "key", "ignore_user_exists", "is_advertising", "stripe_checkout_id_alt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stripe_checkout_id_alt": obj.get("stripe_checkout_id_alt")
        })
        return _obj
