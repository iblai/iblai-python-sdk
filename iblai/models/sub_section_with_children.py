...
class SubSectionWithChildren(BaseModel):
    """
    ...
    units: List[UnitWithChildren]
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "section", "display_name", "status", "units", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "units": [UnitWithChildren.from_dict(_item) for _item in obj["units"]] if obj.get("units") is not None else None,
