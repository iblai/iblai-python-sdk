...
class TenantLaunchRequest(BaseModel):
    """
    TenantLaunchRequest
    """ # noqa: E501
    username: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["username", "email", "firstname", "lastname", "password", "name", "key", "ignore_user_exists", "is_advertising"]
