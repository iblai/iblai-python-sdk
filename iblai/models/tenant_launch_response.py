...
class TenantLaunchResponse(BaseModel):
    """
    ...
    edx_role: StrictStr
    __properties: ClassVar[List[str]] = ["success", "message", "data", "id", "timestamp", "org", "lms_url", "cms_url", "portal_url", "edx_role"]
