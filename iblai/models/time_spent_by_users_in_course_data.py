...
class TimeSpentByUsersInCourseData(BaseModel):
    """
    ...
    assessments: StrictInt = Field(description="Total assessments")
    time_spent: StrictStr = Field(description="Time spent formatted in seconds")
    __properties: ClassVar[List[str]] = ["username", "full_name", "email", "assessments", "time_spent"]
