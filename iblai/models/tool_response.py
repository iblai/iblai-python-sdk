...
class ToolResponse(BaseModel):
    ...
    is_allowed: StrictStr
    __properties: ClassVar[List[str]] = ["id", "name", "display_name", "slug", "category", "description", "logo", "metadata", "allow_base_agent", "allow_openai_agent", "allow_openai_assistant", "allow_google_agent", "is_allowed"]
