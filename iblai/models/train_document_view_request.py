...
class TrainDocumentViewRequest(BaseModel):
    ...
    github_access_token: Optional[StrictStr] = Field(default=None, description="GitHub access token with repo scope. Required for private repositories.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "github_access_token": obj.get("github_access_token")
        })
        return _obj
