...
class Training(BaseModel):
    ...
    retry_attempts: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    ...
    batch_size: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    num_epochs: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    block_size: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    warmup_ratio: Optional[Union[StrictFloat, StrictInt]] = None
    lora_r: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    lora_alpha: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    lora_dropout: Optional[Union[StrictFloat, StrictInt]] = None
    weight_decay: Optional[Union[StrictFloat, StrictInt]] = None
    gradient_accumulation: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
