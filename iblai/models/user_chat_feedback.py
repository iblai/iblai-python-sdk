...
class UserChatFeedback(BaseModel):
    """
    UserChatFeedback
    """ # noqa: E501
    id: StrictInt
    ...
    reason: StrictStr
    additional_feedback: StrictStr
    rating: Optional[RatingEnum] = None
    inserted_at: Optional[datetime] = None
    mentor: StrictInt
    message: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "username", "session", "user_text", "ai_response", "reason", "additional_feedback", "rating", "inserted_at", "mentor", "message"]
