...
class UserGroupPolicy(BaseModel):
    """
    ...
    platform_key: StrictStr = Field(description="Platform key where the usergroup belongs")
    usergroup_id: StrictInt = Field(description="ID of the usergroup to manage access for")
    role: StrictStr = Field(description="Role for accessing this usergroup (read, edit, view analytics, send notifications)")
    resources: Optional[Any] = Field(description="List of resources this policy applies to")
    users: List[RbacUser]
    groups: List[RbacPolicyGroup]
    groups_to_add: Optional[List[StrictInt]] = Field(default=None, description="List of RbacGroup IDs to grant access to this usergroup")
    groups_to_remove: Optional[List[StrictInt]] = Field(default=None, description="List of RbacGroup IDs to revoke access from this usergroup")
    users_to_add: Optional[List[StrictInt]] = Field(default=None, description="List of user IDs to grant access to this usergroup")
    users_to_remove: Optional[List[StrictInt]] = Field(default=None, description="List of user IDs to revoke access from this usergroup")
    __properties: ClassVar[List[str]] = ["id", "name", "platform_key", "usergroup_id", "role", "resources", "users", "groups", "groups_to_add", "groups_to_remove", "users_to_add", "users_to_remove"]
