...
class UserLicenseGroupAssignmentDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "group_id", "group_name", "active", "fulfilled", "redirect_to", "metadata", "license_id", "license_name", "platform_key"]
