...
class UserLicenseUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["license_id", "external_id", "platform_key", "platform_org", "name", "count", "started", "expired", "active", "metadata", "enrollment_config", "source", "transaction_id", "change_type"]
