...
class UserMemory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "mode", "name", "email", "unique_id", "username", "platform", "mentor", "session_id", "catalog_item_type", "catalog_item_id", "entries", "inserted_at", "updated_at", "is_auto_generated", "category"]
