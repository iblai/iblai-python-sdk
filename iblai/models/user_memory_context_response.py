...
class UserMemoryContextResponse(BaseModel):
    ...
    """ # noqa: E501
    username: Annotated[str, Field(strict=True, max_length=500)]
    platform_key: Annotated[str, Field(strict=True, max_length=500)]
    extra_data: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["username", "platform_key", "extra_data", "use_reported_skills", "use_desired_skills", "use_credentials", "use_enrolled_courses", "use_time_spent", "use_completed_courses", "use_completed_programs"]
