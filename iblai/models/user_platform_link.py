...
class UserPlatformLink(BaseModel):
    ...
    show_paywall: StrictBool
    __properties: ClassVar[List[str]] = ["user_id", "username", "email", "user_active", "key", "org", "platform_name", "lms_url", "cms_url", "portal_url", "is_admin", "is_staff", "added_on", "expired_on", "public", "active", "is_enterprise", "show_paywall"]
