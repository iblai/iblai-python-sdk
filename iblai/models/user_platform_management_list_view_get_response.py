...
class UserPlatformManagementListViewGetResponse(BaseModel):
    """
    UserPlatformManagementListViewGetResponse
    """ # noqa: E501
    count: StrictInt
    next_page: StrictInt
    previous_page: StrictInt
    results: List[Dict[str, Any]]
    allowed_policies: Optional[List[StrictStr]] = None
    data: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["count", "next_page", "previous_page", "results", "allowed_policies", "data"]
