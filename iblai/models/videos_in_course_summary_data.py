...
class VideosInCourseSummaryData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "subsections": [VideosWatchedSubSection.from_dict(_item) for _item in obj["subsections"]] if obj.get("subsections") is not None else None
        })
        return _obj
