...
class WatchedVideosPerCourseData(BaseModel):
    """
    ...
    count: StrictInt = Field(description="Number of watched videos")
    percentage: Union[StrictFloat, StrictInt] = Field(description="Percentage ...")
    __properties: ClassVar[List[str]] = ["course_id", "name", "count", "percentage"]
