...
class WatchedVideosPerUserData(BaseModel):
    """
    WatchedVideosPerUserData
    """ # noqa: E501
    username: StrictStr = Field(description="learner username")
    full_name: StrictStr = Field(description="learner fullname")
    count: StrictInt = Field(description="Videos watched count")
    percentage: Union[StrictFloat, StrictInt] = Field(description="Percentage ...")
    __properties: ClassVar[List[str]] = ["username", "full_name", "count", "percentage"]
