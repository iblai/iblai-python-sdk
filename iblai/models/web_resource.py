...
class WebResource(BaseModel):
    ...
    card: Optional[WebResourceCard] = None
    __properties: ClassVar[List[str]] = ["content", "title", "imageUrl", "source", "metadata", "card"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "card": WebResourceCard.from_dict(obj["card"]) if obj.get("card") is not None else None
        })
        return _obj
