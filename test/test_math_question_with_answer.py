...
class TestMathQuestionWithAnswer(unittest.TestCase):
    """MathQuestionWithAnswer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MathQuestionWithAnswer:
        """Test MathQuestionWithAnswer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MathQuestionWithAnswer`
        """
        model = MathQuestionWithAnswer()
        if include_optional:
            return MathQuestionWithAnswer(
                id = 56,
    ...
    def testMathQuestionWithAnswer(self):
        """Test MathQuestionWithAnswer"""
