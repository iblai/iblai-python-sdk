...
class TestStudentAnswer(unittest.TestCase):
    """StudentAnswer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudentAnswer:
        """Test StudentAnswer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudentAnswer`
        """
        model = StudentAnswer()
        if include_optional:
